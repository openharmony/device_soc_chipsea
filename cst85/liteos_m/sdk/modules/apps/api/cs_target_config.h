...
#define TWS_SLAVE_CONNECT_MASTER        0
#define TWS_MSS_AUTO_TEST               0
#define TWS_SENDING_DATA_TEST           0
//end
/* TEST_MODE_ROLE_SEND
...
#define AON_APP_STATIC_LEN              512
    ...
    #define TWS_BLE_CONNECT                 1//CS VENDOR CONNECTION is support
    #else
    #define TWS_BLE_CONNECT                 0//no tws ble
    #endif
...
#endif
#if SCO_CVSD_PLC_TEST == 1 || MAX_THROUGHPUT_TEST == 1
...
/*
 *NOTE :
 *CSBT_PATCH_ASIC_U02_ENABLE = 1, asic rom patch for U02 enabled
 *CSBT_PATCH_FPGA_U02_ENABLE = 1, fpga rom patch for U02 enabled
 *CSBT_PATCH_ASIC_U02_ENABLE and CSBT_PATCH_FPGA_U02_ENABLE
 *CAN NOT be 1 at same time
 *but CAN both be 0.
 */

#define CSBT_PATCH_ASIC_U02_ENABLE      1
#define CSBT_PATCH_FPGA_U02_ENABLE      0
#if (CFG_ROM_VER == 2)
#define CSBT_PATCH_U02_ENABLE           (CSBT_PATCH_ASIC_U02_ENABLE || CSBT_PATCH_FPGA_U02_ENABLE)
#else
#define CSBT_PATCH_U02_ENABLE           0
#endif

#define CSBT_PATCH_ASIC_U03_ENABLE      1
#define CSBT_PATCH_FPGA_U03_ENABLE      0
#if (CFG_ROM_VER == 3)
#define CSBT_PATCH_U03_ENABLE           (CSBT_PATCH_ASIC_U03_ENABLE || CSBT_PATCH_FPGA_U03_ENABLE)
#else
#define CSBT_PATCH_U03_ENABLE           0
#endif

#define CSBT_PATCH_ENABLE               (CSBT_PATCH_U02_ENABLE || CSBT_PATCH_U03_ENABLE)
