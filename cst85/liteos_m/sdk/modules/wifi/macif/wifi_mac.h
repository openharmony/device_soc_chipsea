 ...
 ****************************************************************************************
 */
__STATIC_INLINE int phy_freq_to_channel(uint8_t band, uint16_t freq)
{
    int channel = 0;
...
__STATIC_INLINE uint16_t phy_channel_to_freq(uint8_t band, int channel)
{
