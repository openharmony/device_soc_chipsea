 ...
 */
#ifndef _WIFI_LMAC_MSG_H
#define _WIFI_LMAC_MSG_H
...
enum mm_msg_tag
{
    ...
    MM_SET_ARPOFFLOAD_REQ, //add by cs
    MM_SET_ARPOFFLOAD_CFM, //add by cs
    MM_SET_AGG_DISABLE_REQ, //add by cs
    MM_SET_AGG_DISABLE_CFM, //add by cs                                    // 100
    MM_SET_COEX_REQ, //add by cs
    MM_SET_COEX_CFM, //add by cs
    MM_SET_RF_CONFIG_REQ, //add by cs
    MM_SET_RF_CONFIG_CFM, //add by cs
    MM_SET_RF_CALIB_REQ, //add by cs
    MM_SET_RF_CALIB_CFM, //add by cs
