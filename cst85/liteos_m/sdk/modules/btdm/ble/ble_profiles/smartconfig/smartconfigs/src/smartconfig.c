...
{
    struct smartconfig_env_tag* smartconfig_env = (struct smartconfig_env_tag*) env->env;
    struct prf_svc smartconfig_smartconfigc = {smartconfig_env->shdl, smartconfig_env->shdl + SMARTCONFIG_IDX_NB};
    prf_register_atthdl2gatt(env->env, conidx, &smartconfig_smartconfigc);
}
