...
#include "ble_hl_config.h"

#if (BLE_APP_PRESENT)

#include "app_present_task.h"             // Application Manager Task API
#include "app_present.h"                  // Application Manager Definition
...
#include "ble_ke_timer.h"             // Kernel timer
#include "csble.h"

#if (BLE_APP_SEC)
#include "app_present_sec.h"              // Security Module Definition
#endif //(BLE_APP_SEC)
