...
typedef struct _CS_ADP_AVRCP_EVENT_{
    BT_ADDR bdaddr;
    U32 avrcpparam;
}CS_ADP_AVRCP_EVENT;


void cs_adp_avrcp_send_key_stop(BT_ADDR bdaddr);
void cs_adp_avrcp_send_key_play(BT_ADDR bdaddr);
void cs_adp_avrcp_send_key_pause(BT_ADDR bdaddr);
void cs_adp_avrcp_send_key_forward(BT_ADDR bdaddr);
void cs_adp_avrcp_send_key_backward(BT_ADDR bdaddr);
void cs_adp_avrcp_send_key_volume_up(BT_ADDR bdaddr);
void cs_adp_avrcp_send_key_volume_down(BT_ADDR bdaddr);
Status_BTDef cs_adp_avrcp_send_volume_report(BT_ADDR bdaddr,                U8 volume);
void cs_adp_avrcp_register(   void);
void cs_adp_avrcp_init(void);
void cs_adp_avrcp_support_volume_sync(BOOL support);
#endif
