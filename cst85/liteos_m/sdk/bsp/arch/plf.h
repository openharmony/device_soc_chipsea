...
/*
 * CS_VENDOR_ADV Support
 ****************************************************************************************
 */
#ifdef CFG_CS_VENDOR_ADV
#define PLF_CS_VENDOR_ADV     1
#else // CFG_CS_VENDOR_ADV
#define PLF_CS_VENDOR_ADV     0
#endif // CFG_CS_VENDOR_ADV
/*
 * Audio
 ****************************************************************************************
 */
...
#if defined(CFG_CS1000_MIC_MATRIX) && (CFG_CS1000_MIC_MATRIX < 6)
#define PLF_CS1000_MIC_MATRIX    CFG_CS1000_MIC_MATRIX
#else // CFG_CS1000_MIC_MATRIX
#error "Invalid CS1000 MIC MATRIX"
#endif // CFG_CS1000_MIC_MATRIX

#ifdef CFG_EXT_CS1000
#define PLF_EXT_CS1000        1
#else // CFG_EXT_CS1000
#define PLF_EXT_CS1000        0
#endif // CFG_EXT_CS1000
...
/*
 * PMIC option: use ldo_vcore09 or not
 ****************************************************************************************
 */
#ifdef CFG_PMIC_LDO_VCORE
#define PLF_PMIC_LDO_VCORE  1
#else // CFG_PMIC_LDO_VCORE
#define PLF_PMIC_LDO_VCORE  0
#endif // CFG_PMIC_LDO_VCORE
