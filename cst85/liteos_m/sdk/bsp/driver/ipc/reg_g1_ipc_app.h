...
{
    return PLATFORM_REG_READ(IPC_G1_APP2EMB_TRIGGER_ADDR);
}

__INLINE void ipc_g1_app2emb_trigger_set(uint32_t value)
{
    PLATFORM_REG_WRITE(IPC_G1_APP2EMB_TRIGGER_ADDR, value);
}
...
{
    uint32_t localVal = PLATFORM_REG_READ(IPC_G1_APP2EMB_TRIGGER_ADDR);
    return (localVal >> 0);
}

__INLINE void ipc_g1_app2emb_trigger_setf(uint32_t g1app2embtrigger)
{
    PLATFORM_REG_WRITE(IPC_G1_APP2EMB_TRIGGER_ADDR, (uint32_t)g1app2embtrigger << 0);
}
...
{
    return PLATFORM_REG_READ(IPC_G1_EMB2APP_RAWSTATUS_ADDR);
}
...
{
    uint32_t localVal = PLATFORM_REG_READ(IPC_G1_EMB2APP_RAWSTATUS_ADDR);
    return (localVal >> 0);
}
...
{
    return PLATFORM_REG_READ(IPC_G1_EMB2APP_ACK_ADDR);
}

__INLINE void ipc_g1_emb2app_ack_clear(uint32_t value)
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_ACK_ADDR, value);
}
...
{
    uint32_t localVal = PLATFORM_REG_READ(IPC_G1_EMB2APP_ACK_ADDR);
    return (localVal >> 0);
}

__INLINE void ipc_g1_emb2app_ack_clearf(uint32_t g1emb2appack)
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_ACK_ADDR, (uint32_t)g1emb2appack << 0);
}
...
{
    return PLATFORM_REG_READ(IPC_G1_EMB2APP_UNMASK_SET_ADDR);
}

__INLINE void ipc_g1_emb2app_unmask_set(uint32_t value)
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_UNMASK_SET_ADDR, value);
}
...
{
    uint32_t localVal = PLATFORM_REG_READ(IPC_G1_EMB2APP_UNMASK_SET_ADDR);
    return (localVal >> 0);
}

__INLINE void ipc_g1_emb2app_unmask_setf(uint32_t g1emb2appunmask)
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_UNMASK_SET_ADDR, (uint32_t)g1emb2appunmask << 0);
}
...
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_UNMASK_CLEAR_ADDR, value);
}

// fields defined in symmetrical set/clear register
__INLINE void ipc_g1_emb2app_unmask_clearf(uint32_t g1emb2appunmask)
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_UNMASK_CLEAR_ADDR, (uint32_t)g1emb2appunmask << 0);
}
...
{
    return PLATFORM_REG_READ(IPC_G1_EMB2APP_LINE_SEL_LOW_ADDR);
}

__INLINE void ipc_g1_emb2app_line_sel_low_set(uint32_t value)
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_LINE_SEL_LOW_ADDR, value);
}
...
{
    uint32_t localVal = PLATFORM_REG_READ(IPC_G1_EMB2APP_LINE_SEL_LOW_ADDR);
...
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_LINE_SEL_LOW_ADDR, (PLATFORM_REG_READ(IPC_G1_EMB2APP_LINE_SEL_LOW_ADDR) & ~((uint32_t)0xC0000000)) | ((uint32_t)g1emb2app15sel << 30));
}
...
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_LINE_SEL_LOW_ADDR, (PLATFORM_REG_READ(IPC_G1_EMB2APP_LINE_SEL_LOW_ADDR) & ~((uint32_t)0x30000000)) | ((uint32_t)g1emb2app14sel << 28));
}
...
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_LINE_SEL_LOW_ADDR, (PLATFORM_REG_READ(IPC_G1_EMB2APP_LINE_SEL_LOW_ADDR) & ~((uint32_t)0x0C000000)) | ((uint32_t)g1emb2app13sel << 26));
}
...
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_LINE_SEL_LOW_ADDR, (PLATFORM_REG_READ(IPC_G1_EMB2APP_LINE_SEL_LOW_ADDR) & ~((uint32_t)0x03000000)) | ((uint32_t)g1emb2app12sel << 24));
}
...
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_LINE_SEL_LOW_ADDR, (PLATFORM_REG_READ(IPC_G1_EMB2APP_LINE_SEL_LOW_ADDR) & ~((uint32_t)0x00C00000)) | ((uint32_t)g1emb2app11sel << 22));
}
...
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_LINE_SEL_LOW_ADDR, (PLATFORM_REG_READ(IPC_G1_EMB2APP_LINE_SEL_LOW_ADDR) & ~((uint32_t)0x00300000)) | ((uint32_t)g1emb2app10sel << 20));
}
...
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_LINE_SEL_LOW_ADDR, (PLATFORM_REG_READ(IPC_G1_EMB2APP_LINE_SEL_LOW_ADDR) & ~((uint32_t)0x000C0000)) | ((uint32_t)g1emb2app9sel << 18));
}
...
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_LINE_SEL_LOW_ADDR, (PLATFORM_REG_READ(IPC_G1_EMB2APP_LINE_SEL_LOW_ADDR) & ~((uint32_t)0x00030000)) | ((uint32_t)g1emb2app8sel << 16));
}
...
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_LINE_SEL_LOW_ADDR, (PLATFORM_REG_READ(IPC_G1_EMB2APP_LINE_SEL_LOW_ADDR) & ~((uint32_t)0x0000C000)) | ((uint32_t)g1emb2app7sel << 14));
}
...
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_LINE_SEL_LOW_ADDR, (PLATFORM_REG_READ(IPC_G1_EMB2APP_LINE_SEL_LOW_ADDR) & ~((uint32_t)0x00003000)) | ((uint32_t)g1emb2app6sel << 12));
}
...
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_LINE_SEL_LOW_ADDR, (PLATFORM_REG_READ(IPC_G1_EMB2APP_LINE_SEL_LOW_ADDR) & ~((uint32_t)0x00000C00)) | ((uint32_t)g1emb2app5sel << 10));
}
...
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_LINE_SEL_LOW_ADDR, (PLATFORM_REG_READ(IPC_G1_EMB2APP_LINE_SEL_LOW_ADDR) & ~((uint32_t)0x00000300)) | ((uint32_t)g1emb2app4sel << 8));
}
...
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_LINE_SEL_LOW_ADDR, (PLATFORM_REG_READ(IPC_G1_EMB2APP_LINE_SEL_LOW_ADDR) & ~((uint32_t)0x000000C0)) | ((uint32_t)g1emb2app3sel << 6));
}
...
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_LINE_SEL_LOW_ADDR, (PLATFORM_REG_READ(IPC_G1_EMB2APP_LINE_SEL_LOW_ADDR) & ~((uint32_t)0x00000030)) | ((uint32_t)g1emb2app2sel << 4));
}
...
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_LINE_SEL_LOW_ADDR, (PLATFORM_REG_READ(IPC_G1_EMB2APP_LINE_SEL_LOW_ADDR) & ~((uint32_t)0x0000000C)) | ((uint32_t)g1emb2app1sel << 2));
}
...
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_LINE_SEL_LOW_ADDR, (PLATFORM_REG_READ(IPC_G1_EMB2APP_LINE_SEL_LOW_ADDR) & ~((uint32_t)0x00000003)) | ((uint32_t)g1emb2app0sel << 0));
}
...
{
    return PLATFORM_REG_READ(IPC_G1_EMB2APP_LINE_SEL_HIGH_ADDR);
}

__INLINE void ipc_g1_emb2app_line_sel_high_set(uint32_t value)
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_LINE_SEL_HIGH_ADDR, value);
}
...
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_LINE_SEL_HIGH_ADDR, (PLATFORM_REG_READ(IPC_G1_EMB2APP_LINE_SEL_HIGH_ADDR) & ~((uint32_t)0xC0000000)) | ((uint32_t)g1emb2app31sel << 30));
}
...
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_LINE_SEL_HIGH_ADDR, (PLATFORM_REG_READ(IPC_G1_EMB2APP_LINE_SEL_HIGH_ADDR) & ~((uint32_t)0x30000000)) | ((uint32_t)g1emb2app30sel << 28));
}
...
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_LINE_SEL_HIGH_ADDR, (PLATFORM_REG_READ(IPC_G1_EMB2APP_LINE_SEL_HIGH_ADDR) & ~((uint32_t)0x0C000000)) | ((uint32_t)g1emb2app29sel << 26));
}
...
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_LINE_SEL_HIGH_ADDR, (PLATFORM_REG_READ(IPC_G1_EMB2APP_LINE_SEL_HIGH_ADDR) & ~((uint32_t)0x03000000)) | ((uint32_t)g1emb2app28sel << 24));
}
...
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_LINE_SEL_HIGH_ADDR, (PLATFORM_REG_READ(IPC_G1_EMB2APP_LINE_SEL_HIGH_ADDR) & ~((uint32_t)0x00C00000)) | ((uint32_t)g1emb2app27sel << 22));
}
...
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_LINE_SEL_HIGH_ADDR, (PLATFORM_REG_READ(IPC_G1_EMB2APP_LINE_SEL_HIGH_ADDR) & ~((uint32_t)0x00300000)) | ((uint32_t)g1emb2app26sel << 20));
}
...
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_LINE_SEL_HIGH_ADDR, (PLATFORM_REG_READ(IPC_G1_EMB2APP_LINE_SEL_HIGH_ADDR) & ~((uint32_t)0x000C0000)) | ((uint32_t)g1emb2app25sel << 18));
}
...
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_LINE_SEL_HIGH_ADDR, (PLATFORM_REG_READ(IPC_G1_EMB2APP_LINE_SEL_HIGH_ADDR) & ~((uint32_t)0x00030000)) | ((uint32_t)g1emb2app24sel << 16));
}
...
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_LINE_SEL_HIGH_ADDR, (PLATFORM_REG_READ(IPC_G1_EMB2APP_LINE_SEL_HIGH_ADDR) & ~((uint32_t)0x0000C000)) | ((uint32_t)g1emb2app23sel << 14));
}
...
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_LINE_SEL_HIGH_ADDR, (PLATFORM_REG_READ(IPC_G1_EMB2APP_LINE_SEL_HIGH_ADDR) & ~((uint32_t)0x00003000)) | ((uint32_t)g1emb2app22sel << 12));
}
...
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_LINE_SEL_HIGH_ADDR, (PLATFORM_REG_READ(IPC_G1_EMB2APP_LINE_SEL_HIGH_ADDR) & ~((uint32_t)0x00000C00)) | ((uint32_t)g1emb2app21sel << 10));
}
...
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_LINE_SEL_HIGH_ADDR, (PLATFORM_REG_READ(IPC_G1_EMB2APP_LINE_SEL_HIGH_ADDR) & ~((uint32_t)0x00000300)) | ((uint32_t)g1emb2app20sel << 8));
}
...
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_LINE_SEL_HIGH_ADDR, (PLATFORM_REG_READ(IPC_G1_EMB2APP_LINE_SEL_HIGH_ADDR) & ~((uint32_t)0x000000C0)) | ((uint32_t)g1emb2app19sel << 6));
}
...
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_LINE_SEL_HIGH_ADDR, (PLATFORM_REG_READ(IPC_G1_EMB2APP_LINE_SEL_HIGH_ADDR) & ~((uint32_t)0x00000030)) | ((uint32_t)g1emb2app18sel << 4));
}
...
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_LINE_SEL_HIGH_ADDR, (PLATFORM_REG_READ(IPC_G1_EMB2APP_LINE_SEL_HIGH_ADDR) & ~((uint32_t)0x0000000C)) | ((uint32_t)g1emb2app17sel << 2));
}
...
{
    PLATFORM_REG_WRITE(IPC_G1_EMB2APP_LINE_SEL_HIGH_ADDR, (PLATFORM_REG_READ(IPC_G1_EMB2APP_LINE_SEL_HIGH_ADDR) & ~((uint32_t)0x00000003)) | ((uint32_t)g1emb2app16sel << 0));
}
...
{
    return PLATFORM_REG_READ(IPC_G1_EMB2APP_STATUS_ADDR);
}
...
{
    uint32_t localVal = PLATFORM_REG_READ(IPC_G1_EMB2APP_STATUS_ADDR);
    return (localVal >> 0);
}
