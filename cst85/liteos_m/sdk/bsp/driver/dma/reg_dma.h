...
#define CS_CE_OFST     (0x0044)
#define CS_TRANS_OFST  (0x0090)

static CS_DMA_TypeDef   * const CS_DMA   = ((CS_DMA_TypeDef   *) CS_DMA_BASE);
static CS_CE_TypeDef    * const CS_CE    = ((CS_CE_TypeDef    *)(CS_DMA_BASE + CS_CE_OFST));
static CS_TRANS_TypeDef * const CS_TRANS = ((CS_TRANS_TypeDef *)(CS_DMA_BASE + CS_TRANS_OFST));
...
{
    return (CS_DMA->CH[ch_idx].HLTR & DMA_CH_HALT_SET_BIT);
}

__STATIC_INLINE void dma_ch_hltr_halt_set_setb(int ch_idx)
{
    CS_DMA->CH[ch_idx].HLTR |= DMA_CH_HALT_SET_BIT;
}
...
{
    return (CS_DMA->CH[ch_idx].HLTR & DMA_CH_HALT_STAT_BIT);
}
...
{
    return (CS_DMA->CH[ch_idx].RQR & DMA_CH_SRQ_BIT);
}

__STATIC_INLINE void dma_ch_rqr_srq_setb(int ch_idx)
{
    CS_DMA->CH[ch_idx].RQR |= DMA_CH_SRQ_BIT;
}
...
{
    return (CS_DMA->CH[ch_idx].RQR & DMA_CH_ERQM_BIT);
}

__STATIC_INLINE void dma_ch_rqr_erqm_setb(int ch_idx)
{
    CS_DMA->CH[ch_idx].RQR |= DMA_CH_ERQM_BIT;
}
...
{
    return (CS_DMA->CH[ch_idx].RQR & DMA_CH_ERQL_BIT);
}

__STATIC_INLINE void dma_ch_rqr_erql_setb(int ch_idx)
{
    CS_DMA->CH[ch_idx].RQR |= DMA_CH_ERQL_BIT;
}
...
{
    return (CS_DMA->CH[ch_idx].ICSR & DMA_CH_TBL1_IENA_BIT);
}

__STATIC_INLINE void dma_ch_icsr_tbl1_iena_setb(int ch_idx)
{
    CS_DMA->CH[ch_idx].ICSR |= DMA_CH_TBL1_IENA_BIT;
}
...
{
    return (CS_DMA->CH[ch_idx].ICSR & DMA_CH_TBL2_IENA_BIT);
}

__STATIC_INLINE void dma_ch_icsr_tbl2_iena_setb(int ch_idx)
{
    CS_DMA->CH[ch_idx].ICSR |= DMA_CH_TBL2_IENA_BIT;
}
...
{
    return (CS_DMA->CH[ch_idx].ICSR & DMA_CH_TLL_IENA_BIT);
}

__STATIC_INLINE void dma_ch_icsr_tll_iena_setb(int ch_idx)
{
    CS_DMA->CH[ch_idx].ICSR |= DMA_CH_TLL_IENA_BIT;
}
...
{
    return (CS_DMA->CH[ch_idx].ICSR & DMA_CH_CE_IENA_BIT);
}

__STATIC_INLINE void dma_ch_icsr_ce_iena_setb(int ch_idx)
{
    CS_DMA->CH[ch_idx].ICSR |= DMA_CH_CE_IENA_BIT;
}
...
{
    return (CS_DMA->CH[ch_idx].TBL0CR);
}

__STATIC_INLINE void dma_ch_tbl0cr_set(int ch_idx, uint32_t reg_val)
{
    CS_DMA->CH[ch_idx].TBL0CR = reg_val;
}

__STATIC_INLINE uint32_t dma_ch_tbl0cr_tbl0_cnt_getf(int ch_idx)
{
    return ((CS_DMA->CH[ch_idx].TBL0CR & DMA_CH_TBL0_CNT_MASK) >> DMA_CH_TBL0_CNT_LSB);
}

__STATIC_INLINE void dma_ch_tbl0cr_tbl0_cnt_setf(int ch_idx, uint32_t cnt)
{
    uint32_t local_val;
    local_val = CS_DMA->CH[ch_idx].TBL0CR & ~DMA_CH_TBL0_CNT_MASK;
    CS_DMA->CH[ch_idx].TBL0CR = local_val | ((cnt << DMA_CH_TBL0_CNT_LSB) & DMA_CH_TBL0_CNT_MASK);
}

__STATIC_INLINE uint32_t dma_ch_tbl0cr_lastlli_getb(int ch_idx)
{
    return (CS_DMA->CH[ch_idx].TBL0CR & DMA_CH_LASTLLI_BIT);
}

__STATIC_INLINE void dma_ch_tbl0cr_lastlli_setb(int ch_idx)
{
    CS_DMA->CH[ch_idx].TBL0CR |= DMA_CH_LASTLLI_BIT;
}
...
{
    CS_DMA->ERQCSR[erq_idx] = ch_idx + 1;
}
