...
/// UART index
#if REG_STDIO_UART_BASE_ADDR == CS_UART0_BASE
  #define UART_INDEX        0
#elif REG_STDIO_UART_BASE_ADDR == CS_UART1_BASE
  #define UART_INDEX        1
#elif REG_STDIO_UART_BASE_ADDR == CS_UART2_BASE
  #define UART_INDEX        2
#else
  #error "invalid uart"
#endif
...
__STATIC_INLINE void stdio_uart_dfmtcfg_pack(uint8_t divms, uint8_t divae, uint8_t brk, uint8_t eps, uint8_t pen, uint8_t stop, uint8_t dls)
{
