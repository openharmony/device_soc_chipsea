...
extern uint32_t wifi_txgain_table[32];
extern uint32_t bt_rxgain_table[16][4];
extern uint32_t bt_txgain_table[16][2];

extern uint32_t backup_wifi_rxgain_table_24g[48][4];
extern uint32_t backup_wifi_rxgain_table_5g[32][4];
extern uint32_t backup_wifi_txgain_table[32];
extern uint32_t backup_bt_rxgain_table[16][4];
extern uint32_t backup_bt_txgain_table[16][2];
