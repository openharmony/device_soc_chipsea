...
static CS_CPUSYSCTRL_TypeDef * const CS_CPUSYSCTRL = ((CS_CPUSYSCTRL_TypeDef *)CS_CPUSYSCTRL_BASE);
static CS_AONSYSCTRL_TypeDef * const CS_AONSYSCTRL = ((CS_AONSYSCTRL_TypeDef *)CS_AONSYSCTRL_BASE);
static CS_PWRCTRL_TypeDef    * const CS_PWRCTRL    = ((CS_PWRCTRL_TypeDef    *)CS_PWRCTRL_BASE);
...
{
    return ((CS_AONSYSCTRL->CHIPID & ASC_CHIPID_CHIP_ID_MASK) >> ASC_CHIPID_CHIP_ID_LSB);
}

__STATIC_INLINE uint8_t aonsysctrl_chipid_metal_id_getf(void)
{
    return ((CS_AONSYSCTRL->CHIPID & ASC_CHIPID_METAL_ID_MASK) >> ASC_CHIPID_METAL_ID_LSB);
}

__STATIC_INLINE uint8_t aonsysctrl_chipid_bond_id_getf(void)
{
    return ((CS_AONSYSCTRL->CHIPID & ASC_CHIPID_BOND_ID_MASK) >> ASC_CHIPID_BOND_ID_LSB);
}
...
{
    return CS_AONSYSCTRL->CLKSEL;
}

__STATIC_INLINE void aonsysctrl_clksel_set(uint32_t clk_sel)
{
    CS_AONSYSCTRL->CLKSEL = clk_sel;
}

__STATIC_INLINE uint8_t aonsysctrl_fast_hwen_getb(void)
{
    return (CS_AONSYSCTRL->CLKSEL & ASC_CLKSEL_FASTHWEN_BIT) >> ASC_CLKSEL_FASTHWEN_POS;
}

__STATIC_INLINE void aonsysctrl_fast_hwen_setb(void)
{
    CS_AONSYSCTRL->CLKSEL |=  ASC_CLKSEL_FASTHWEN_BIT;
}
...
{
    return (CS_AONSYSCTRL->CLKSEL & ASC_CLKSEL_FASTCLK_BIT) >> ASC_CLKSEL_FASTCLK_POS;
}

__STATIC_INLINE void aonsysctrl_fast_clk_setb(void)
{
    CS_AONSYSCTRL->CLKSEL |=  ASC_CLKSEL_FASTCLK_BIT;
}
...
{
    return (CS_AONSYSCTRL->CLKSEL & ASC_CLKSEL_PLL320M_BIT) >> ASC_CLKSEL_PLL320M_POS;
}

__STATIC_INLINE void aonsysctrl_pll_320m_setb(void)
{
    CS_AONSYSCTRL->CLKSEL |=  ASC_CLKSEL_PLL320M_BIT;
}
...
{
    return (CS_AONSYSCTRL->CLKSEL & ASC_CLKSEL_PLLFLEX_BIT) >> ASC_CLKSEL_PLLFLEX_POS;
}

__STATIC_INLINE void aonsysctrl_pll_flex_setb(void)
{
    CS_AONSYSCTRL->CLKSEL |=  ASC_CLKSEL_PLLFLEX_BIT;
}
...
{
    return (CS_AONSYSCTRL->CLKSEL & ASC_CLKSEL_AONCLK_BIT) >> ASC_CLKSEL_AONCLK_POS;
}

__STATIC_INLINE void aonsysctrl_aon_clk_setb(void)
{
    CS_AONSYSCTRL->CLKSEL |=  ASC_CLKSEL_AONCLK_BIT;
}
...
{
    return ((CS_AONSYSCTRL->HCLKDIV & ASC_HCLKDIV_DENOM_MASK) >> ASC_HCLKDIV_DENOM_LSB);
}

__STATIC_INLINE void aonsysctrl_hclkdiv_denom_setf(uint8_t div_denom)
{
    uint32_t local_val = CS_AONSYSCTRL->HCLKDIV & ~ASC_HCLKDIV_DENOM_MASK;
    CS_AONSYSCTRL->HCLKDIV = local_val | ((div_denom << ASC_HCLKDIV_DENOM_LSB) & ASC_HCLKDIV_DENOM_MASK) | ASC_HCLKDIV_UPDATE_BIT;
}
...
{
    return ((CS_AONSYSCTRL->FCLKDIV & ASC_FCLKDIV_DENOM_MASK) >> ASC_FCLKDIV_DENOM_LSB);
}

__STATIC_INLINE void aonsysctrl_fclkdiv_denom_setf(uint8_t div_denom)
{
    uint32_t local_val = CS_AONSYSCTRL->FCLKDIV & ~ASC_FCLKDIV_DENOM_MASK;
    CS_AONSYSCTRL->FCLKDIV = local_val | ((div_denom << ASC_FCLKDIV_DENOM_LSB) & ASC_FCLKDIV_DENOM_MASK) | ASC_FCLKDIV_UPDATE_BIT;
}
...
{
    return CS_AONSYSCTRL->RSTCAUSE;
}

__STATIC_INLINE uint8_t aonsysctrl_rstcause_wdt0_rst_getb(void)
{
    return (CS_AONSYSCTRL->RSTCAUSE & ASC_RSTCAUSE_WDT0_RST_BIT) >> ASC_RSTCAUSE_WDT0_RST_POS;
}

__STATIC_INLINE uint8_t aonsysctrl_rstcause_wdt1_rst_getb(void)
{
    return (CS_AONSYSCTRL->RSTCAUSE & ASC_RSTCAUSE_WDT1_RST_BIT) >> ASC_RSTCAUSE_WDT1_RST_POS;
}

__STATIC_INLINE uint8_t aonsysctrl_rstcause_wdt2_rst_getb(void)
{
    return (CS_AONSYSCTRL->RSTCAUSE & ASC_RSTCAUSE_WDT2_RST_BIT) >> ASC_RSTCAUSE_WDT2_RST_POS;
}

__STATIC_INLINE uint8_t aonsysctrl_rstcause_wdt3_rst_getb(void)
{
    return (CS_AONSYSCTRL->RSTCAUSE & ASC_RSTCAUSE_WDT3_RST_BIT) >> ASC_RSTCAUSE_WDT3_RST_POS;
}

__STATIC_INLINE uint8_t aonsysctrl_rstcause_wdt4_rst_getb(void)
{
    return (CS_AONSYSCTRL->RSTCAUSE & ASC_RSTCAUSE_WDT4_RST_BIT) >> ASC_RSTCAUSE_WDT4_RST_POS;
}

__STATIC_INLINE uint8_t aonsysctrl_rstcause_cpup_sysrst_req_getb(void)
{
    return (CS_AONSYSCTRL->RSTCAUSE & ASC_RSTCAUSE_CPUP_SYSRST_REQ_BIT) >> ASC_RSTCAUSE_CPUP_SYSRST_REQ_POS;
}

__STATIC_INLINE uint8_t aonsysctrl_rstcause_cpusw_sysrst_req_getb(void)
{
    return (CS_AONSYSCTRL->RSTCAUSE & ASC_RSTCAUSE_CPUSW_SYSRST_REQ_BIT) >> ASC_RSTCAUSE_CPUSW_SYSRST_REQ_POS;
}

__STATIC_INLINE uint8_t aonsysctrl_rstcause_dsp_sysrst_req_getb(void)
{
    return (CS_AONSYSCTRL->RSTCAUSE & ASC_RSTCAUSE_DSP_SYSRST_REQ_BIT) >> ASC_RSTCAUSE_DSP_SYSRST_REQ_POS;
}

__STATIC_INLINE uint8_t aonsysctrl_rstcause_cpusb_sysrst_req_getb(void)
{
    return (CS_AONSYSCTRL->RSTCAUSE & ASC_RSTCAUSE_CPUSB_SYSRST_REQ_BIT) >> ASC_RSTCAUSE_CPUSB_SYSRST_REQ_POS;
}

__STATIC_INLINE uint8_t aonsysctrl_rstcause_cpuaon_sysrst_req_getb(void)
{
    return (CS_AONSYSCTRL->RSTCAUSE & ASC_RSTCAUSE_CPUAON_SYSRST_REQ_BIT) >> ASC_RSTCAUSE_CPUAON_SYSRST_REQ_POS;
}

__STATIC_INLINE uint8_t aonsysctrl_rstcause_global_soft_reset_getb(void)
{
    return (CS_AONSYSCTRL->RSTCAUSE & ASC_RSTCAUSE_GLOBAL_SOFT_RESET_BIT) >> ASC_RSTCAUSE_GLOBAL_SOFT_RESET_POS;
}
...
{
    return ((CS_AONSYSCTRL->PSRCLKDIV & ASC_PSRCLKDIV_DENOM_MASK) >> ASC_PSRCLKDIV_DENOM_LSB);
}

__STATIC_INLINE void aonsysctrl_psrclkdiv_denom_setf(uint8_t div_denom)
{
    uint32_t local_val = CS_AONSYSCTRL->PSRCLKDIV & ~ASC_PSRCLKDIV_DENOM_MASK;
    CS_AONSYSCTRL->PSRCLKDIV = local_val | ((div_denom << ASC_PSRCLKDIV_DENOM_LSB) & ASC_PSRCLKDIV_DENOM_MASK) | ASC_PSRCLKDIV_UPDATE_BIT;
}
...
{
    return (CS_AONSYSCTRL->PSRCLKSEL & ASC_PSRCLKSEL_FAST_BIT) >> ASC_PSRCLKSEL_FAST_POS;
}

__STATIC_INLINE void aonsysctrl_psrclksel_fast_setb(void)
{
    CS_AONSYSCTRL->PSRCLKSEL |=  ASC_PSRCLKSEL_FAST_BIT;
}
...
{
    return CS_AONSYSCTRL->AONSRAMCFG1;
}

__STATIC_INLINE void aonsysctrl_aonsramcfg1_set(uint32_t config)
{
    CS_AONSYSCTRL->AONSRAMCFG1 = config;
}
...
{
    return CS_AONSYSCTRL->AONSRAMCFG2;
}

__STATIC_INLINE void aonsysctrl_aonsramcfg2_set(uint32_t config)
{
    CS_AONSYSCTRL->AONSRAMCFG2 = config;
}
...
{
    return CS_AONSYSCTRL->SRAMSDCFG;
}

__STATIC_INLINE void aonsysctrl_sramsdcfg_set(uint32_t config)
{
    CS_AONSYSCTRL->SRAMSDCFG = config;
}

__STATIC_INLINE uint8_t aonsysctrl_sramsdcfg_sram0_getb(void)
{
    return (CS_AONSYSCTRL->SRAMSDCFG & ASC_SRAMSDCFG_SRAM0_BIT) >> ASC_SRAMSDCFG_SRAM0_POS;
}

__STATIC_INLINE void aonsysctrl_sramsdcfg_sram0_setb(void)
{
    CS_AONSYSCTRL->SRAMSDCFG |=  ASC_SRAMSDCFG_SRAM0_BIT;
}
...
{
    return (CS_AONSYSCTRL->SRAMSDCFG & ASC_SRAMSDCFG_SRAM1_BIT) >> ASC_SRAMSDCFG_SRAM1_POS;
}

__STATIC_INLINE void aonsysctrl_sramsdcfg_sram1_setb(void)
{
    CS_AONSYSCTRL->SRAMSDCFG |=  ASC_SRAMSDCFG_SRAM1_BIT;
}
...
{
    return (CS_AONSYSCTRL->SRAMSDCFG & ASC_SRAMSDCFG_SRAM2_BIT) >> ASC_SRAMSDCFG_SRAM2_POS;
}

__STATIC_INLINE void aonsysctrl_sramsdcfg_sram2_setb(void)
{
    CS_AONSYSCTRL->SRAMSDCFG |=  ASC_SRAMSDCFG_SRAM2_BIT;
}
...
{
    return (CS_AONSYSCTRL->SRAMSDCFG & ASC_SRAMSDCFG_SRAM3_BIT) >> ASC_SRAMSDCFG_SRAM3_POS;
}

__STATIC_INLINE void aonsysctrl_sramsdcfg_sram3_setb(void)
{
    CS_AONSYSCTRL->SRAMSDCFG |=  ASC_SRAMSDCFG_SRAM3_BIT;
}
...
{
    return (CS_AONSYSCTRL->SRAMSDCFG & ASC_SRAMSDCFG_SRAM4_BIT) >> ASC_SRAMSDCFG_SRAM4_POS;
}

__STATIC_INLINE void aonsysctrl_sramsdcfg_sram4_setb(void)
{
    CS_AONSYSCTRL->SRAMSDCFG |=  ASC_SRAMSDCFG_SRAM4_BIT;
}
...
{
    return (CS_AONSYSCTRL->SRAMSDCFG & ASC_SRAMSDCFG_SRAM5_BIT) >> ASC_SRAMSDCFG_SRAM5_POS;
}

__STATIC_INLINE void aonsysctrl_sramsdcfg_sram5_setb(void)
{
    CS_AONSYSCTRL->SRAMSDCFG |=  ASC_SRAMSDCFG_SRAM5_BIT;
}
...
{
    return (CS_AONSYSCTRL->SRAMSDCFG & ASC_SRAMSDCFG_SRAM6_BIT) >> ASC_SRAMSDCFG_SRAM6_POS;
}

__STATIC_INLINE void aonsysctrl_sramsdcfg_sram6_setb(void)
{
    CS_AONSYSCTRL->SRAMSDCFG |=  ASC_SRAMSDCFG_SRAM6_BIT;
}
...
{
    return (CS_AONSYSCTRL->SRAMSDCFG & ASC_SRAMSDCFG_ROM0_BIT) >> ASC_SRAMSDCFG_ROM0_POS;
}

__STATIC_INLINE void aonsysctrl_sramsdcfg_rom0_setb(void)
{
    CS_AONSYSCTRL->SRAMSDCFG |=  ASC_SRAMSDCFG_ROM0_BIT;
}
...
{
    return (CS_AONSYSCTRL->SRAMSDCFG & ASC_SRAMSDCFG_ROM1_BIT) >> ASC_SRAMSDCFG_ROM1_POS;
}

__STATIC_INLINE void aonsysctrl_sramsdcfg_rom1_setb(void)
{
    CS_AONSYSCTRL->SRAMSDCFG |=  ASC_SRAMSDCFG_ROM1_BIT;
}
...
{
    return (CS_AONSYSCTRL->SRAMSDCFG & ASC_SRAMSDCFG_ROM2_BIT) >> ASC_SRAMSDCFG_ROM2_POS;
}

__STATIC_INLINE void aonsysctrl_sramsdcfg_rom2_setb(void)
{
    CS_AONSYSCTRL->SRAMSDCFG |=  ASC_SRAMSDCFG_ROM2_BIT;
}
...
{
    return (CS_AONSYSCTRL->SRAMSDCFG & ASC_SRAMSDCFG_BTROM0_BIT) >> ASC_SRAMSDCFG_BTROM0_POS;
}

__STATIC_INLINE void aonsysctrl_sramsdcfg_btrom0_setb(void)
{
    CS_AONSYSCTRL->SRAMSDCFG |=  ASC_SRAMSDCFG_BTROM0_BIT;
}
...
{
    return (CS_AONSYSCTRL->SRAMSDCFG & ASC_SRAMSDCFG_BTROM1_BIT) >> ASC_SRAMSDCFG_BTROM1_POS;
}

__STATIC_INLINE void aonsysctrl_sramsdcfg_btrom1_setb(void)
{
    CS_AONSYSCTRL->SRAMSDCFG |=  ASC_SRAMSDCFG_BTROM1_BIT;
}
...
{
    return (CS_AONSYSCTRL->SRAMSDCFG & ASC_SRAMSDCFG_BTROM2_BIT) >> ASC_SRAMSDCFG_BTROM2_POS;
}

__STATIC_INLINE void aonsysctrl_sramsdcfg_btrom2_setb(void)
{
    CS_AONSYSCTRL->SRAMSDCFG |=  ASC_SRAMSDCFG_BTROM2_BIT;
}
...
{
    return ((CS_AONSYSCTRL->AONCLKDIV & ASC_AONCLKDIV_DENOM_MASK) >> ASC_AONCLKDIV_DENOM_LSB);
}

__STATIC_INLINE void aonsysctrl_aonclkdiv_denom_setf(uint8_t div_denom)
{
    uint32_t local_val = CS_AONSYSCTRL->AONCLKDIV & ~ASC_AONCLKDIV_DENOM_MASK;
    CS_AONSYSCTRL->AONCLKDIV = local_val | ((div_denom << ASC_AONCLKDIV_DENOM_LSB) & ASC_AONCLKDIV_DENOM_MASK) | ASC_AONCLKDIV_UPDATE_BIT;
}
...
{
    return (CS_AONSYSCTRL->AONRAMMUX & ASC_AONRAMMUX_HI32K_BIT) >> ASC_AONRAMMUX_HI32K_POS;
}

__STATIC_INLINE void aonsysctrl_aonrammux_hi32k_setb(void)
{
    CS_AONSYSCTRL->AONRAMMUX |=  ASC_AONRAMMUX_HI32K_BIT;
}
...
{
    return (CS_AONSYSCTRL->AONRAMMUX & ASC_AONRAMMUX_LO32K_BIT) >> ASC_AONRAMMUX_LO32K_POS;
}

__STATIC_INLINE void aonsysctrl_aonrammux_lo32k_setb(void)
{
    CS_AONSYSCTRL->AONRAMMUX |=  ASC_AONRAMMUX_LO32K_BIT;
}
...
{
    return (CS_AONSYSCTRL->OSCEN & ASC_OSCEN_BT_OSC_EN_BIT) >> ASC_OSCEN_BT_OSC_EN_POS;
}

__STATIC_INLINE void aonsysctrl_oscen_bt_osc_en_setb(void)
{
    CS_AONSYSCTRL->OSCEN |=  ASC_OSCEN_BT_OSC_EN_BIT;
}
...
{
    return (CS_AONSYSCTRL->OSCEN & ASC_OSCEN_WIFI_OSC_EN_BIT) >> ASC_OSCEN_WIFI_OSC_EN_POS;
}

__STATIC_INLINE void aonsysctrl_oscen_wifi_osc_en_setb(void)
{
    CS_AONSYSCTRL->OSCEN |=  ASC_OSCEN_WIFI_OSC_EN_BIT;
}
...
{
    return (CS_AONSYSCTRL->OSCEN & ASC_OSCEN_BT_OSC_MANUAL_BIT) >> ASC_OSCEN_BT_OSC_MANUAL_POS;
}

__STATIC_INLINE void aonsysctrl_oscen_bt_osc_manual_setb(void)
{
    CS_AONSYSCTRL->OSCEN |=  ASC_OSCEN_BT_OSC_MANUAL_BIT;
}
...
{
    return (CS_AONSYSCTRL->OSCEN & ASC_OSCEN_WIFI_OSC_MANUAL_BIT) >> ASC_OSCEN_WIFI_OSC_MANUAL_POS;
}

__STATIC_INLINE void aonsysctrl_oscen_wifi_osc_manual_setb(void)
{
    CS_AONSYSCTRL->OSCEN |=  ASC_OSCEN_WIFI_OSC_MANUAL_BIT;
}
...
{
    return (CS_AONSYSCTRL->OSCEN & ASC_OSCEN_WIFI_OSC_COMB_EN_BIT) >> ASC_OSCEN_WIFI_OSC_COMB_EN_POS;
}

__STATIC_INLINE void aonsysctrl_oscen_wifi_osc_comb_en_setb(void)
{
    CS_AONSYSCTRL->OSCEN |=  ASC_OSCEN_WIFI_OSC_COMB_EN_BIT;
}
...
{
    return CS_AONSYSCTRL->HCLKME;
}

__STATIC_INLINE void aonsysctrl_hclkme_set(uint32_t enable_bits)
{
    CS_AONSYSCTRL->HCLKME = enable_bits;
}

__STATIC_INLINE uint8_t aonsysctrl_hclkme_cpusys_en_getb(void)
{
    return (CS_AONSYSCTRL->HCLKME & ASC_HCLKME_CPUSYS_EN_BIT) >> ASC_HCLKME_CPUSYS_EN_POS;
}

__STATIC_INLINE void aonsysctrl_hclkme_cpusys_en_setb(void)
{
    CS_AONSYSCTRL->HCLKME = ASC_HCLKME_CPUSYS_EN_BIT;
}

__STATIC_INLINE uint8_t aonsysctrl_hclkme_btsys_en_getb(void)
{
    return (CS_AONSYSCTRL->HCLKME & ASC_HCLKME_BTSYS_EN_BIT) >> ASC_HCLKME_BTSYS_EN_POS;
}

__STATIC_INLINE void aonsysctrl_hclkme_btsys_en_setb(void)
{
    CS_AONSYSCTRL->HCLKME = ASC_HCLKME_BTSYS_EN_BIT;
}

__STATIC_INLINE uint8_t aonsysctrl_hclkme_btfree_en_getb(void)
{
    return (CS_AONSYSCTRL->HCLKME & ASC_HCLKME_BTFREE_EN_BIT) >> ASC_HCLKME_BTFREE_EN_POS;
}

__STATIC_INLINE void aonsysctrl_hclkme_btfree_en_setb(void)
{
    CS_AONSYSCTRL->HCLKME = ASC_HCLKME_BTFREE_EN_BIT;
}

__STATIC_INLINE uint8_t aonsysctrl_hclkme_wifisys_en_getb(void)
{
    return (CS_AONSYSCTRL->HCLKME & ASC_HCLKME_WIFISYS_EN_BIT) >> ASC_HCLKME_WIFISYS_EN_POS;
}

__STATIC_INLINE void aonsysctrl_hclkme_wifisys_en_setb(void)
{
    CS_AONSYSCTRL->HCLKME = ASC_HCLKME_WIFISYS_EN_BIT;
}
...
{
    return CS_AONSYSCTRL->HCLKMD;
}

__STATIC_INLINE void aonsysctrl_hclkmd_set(uint32_t disable_bits)
{
    CS_AONSYSCTRL->HCLKMD = disable_bits;
}

__STATIC_INLINE uint8_t aonsysctrl_hclkmd_cpusys_dis_getb(void)
{
    return (CS_AONSYSCTRL->HCLKMD & ASC_HCLKMD_CPUSYS_DIS_BIT) >> ASC_HCLKMD_CPUSYS_DIS_POS;
}

__STATIC_INLINE void aonsysctrl_hclkmd_cpusys_dis_setb(void)
{
    CS_AONSYSCTRL->HCLKMD = ASC_HCLKMD_CPUSYS_DIS_BIT;
}

__STATIC_INLINE uint8_t aonsysctrl_hclkmd_btsys_dis_getb(void)
{
    return (CS_AONSYSCTRL->HCLKMD & ASC_HCLKMD_BTSYS_DIS_BIT) >> ASC_HCLKMD_BTSYS_DIS_POS;
}

__STATIC_INLINE void aonsysctrl_hclkmd_btsys_dis_setb(void)
{
    CS_AONSYSCTRL->HCLKMD = ASC_HCLKMD_BTSYS_DIS_BIT;
}

__STATIC_INLINE uint8_t aonsysctrl_hclkmd_btfree_dis_getb(void)
{
    return (CS_AONSYSCTRL->HCLKMD & ASC_HCLKMD_BTFREE_DIS_BIT) >> ASC_HCLKMD_BTFREE_DIS_POS;
}

__STATIC_INLINE void aonsysctrl_hclkmd_btfree_dis_setb(void)
{
    CS_AONSYSCTRL->HCLKMD = ASC_HCLKMD_BTFREE_DIS_BIT;
}

__STATIC_INLINE uint8_t aonsysctrl_hclkmd_wifisys_dis_getb(void)
{
    return (CS_AONSYSCTRL->HCLKMD & ASC_HCLKMD_WIFISYS_DIS_BIT) >> ASC_HCLKMD_WIFISYS_DIS_POS;
}

__STATIC_INLINE void aonsysctrl_hclkmd_wifisys_dis_setb(void)
{
    CS_AONSYSCTRL->HCLKMD = ASC_HCLKMD_WIFISYS_DIS_BIT;
}
...
{
    return (CS_AONSYSCTRL->GLBRS & ASC_GLBRS_SOFTSET_BIT) >> ASC_GLBRS_SOFTSET_POS;
}

__STATIC_INLINE void aonsysctrl_glbrs_softset_setb(void)
{
    CS_AONSYSCTRL->GLBRS = ASC_GLBRS_SOFTSET_BIT;
}
...
{
    return (CS_AONSYSCTRL->GLBRC & ASC_GLBRC_SOFTCLR_BIT) >> ASC_GLBRC_SOFTCLR_POS;
}

__STATIC_INLINE void aonsysctrl_glbrc_softclr_setb(void)
{
    CS_AONSYSCTRL->GLBRC = ASC_GLBRC_SOFTCLR_BIT;
}
...
{
    return CS_AONSYSCTRL->HCLKRS;
}

__STATIC_INLINE void aonsysctrl_hclkrs_set(uint32_t reset_bits)
{
    CS_AONSYSCTRL->HCLKRS = reset_bits;
}

__STATIC_INLINE uint8_t aonsysctrl_hclkrs_cpusbset_getb(void)
{
    return (CS_AONSYSCTRL->HCLKRS & ASC_HCLKRS_CPUSBSET_BIT) >> ASC_HCLKRS_CPUSBSET_POS;
}

__STATIC_INLINE void aonsysctrl_hclkrs_cpusbset_setb(void)
{
    CS_AONSYSCTRL->HCLKRS = ASC_HCLKRS_CPUSBSET_BIT;
}

__STATIC_INLINE uint8_t aonsysctrl_hclkrs_cpuswset_getb(void)
{
    return (CS_AONSYSCTRL->HCLKRS & ASC_HCLKRS_CPUSWSET_BIT) >> ASC_HCLKRS_CPUSWSET_POS;
}

__STATIC_INLINE void aonsysctrl_hclkrs_cpuswset_setb(void)
{
    CS_AONSYSCTRL->HCLKRS = ASC_HCLKRS_CPUSWSET_BIT;
}

__STATIC_INLINE uint8_t aonsysctrl_hclkrs_dspset_getb(void)
{
    return (CS_AONSYSCTRL->HCLKRS & ASC_HCLKRS_DSPSET_BIT) >> ASC_HCLKRS_DSPSET_POS;
}

__STATIC_INLINE void aonsysctrl_hclkrs_dspset_setb(void)
{
    CS_AONSYSCTRL->HCLKRS = ASC_HCLKRS_DSPSET_BIT;
}
...
{
    return CS_AONSYSCTRL->HCLKRC;
}

__STATIC_INLINE void aonsysctrl_hclkrc_set(uint32_t reset_bits)
{
    CS_AONSYSCTRL->HCLKRC = reset_bits;
}

__STATIC_INLINE uint8_t aonsysctrl_hclkrc_cpusbclr_getb(void)
{
    return (CS_AONSYSCTRL->HCLKRC & ASC_HCLKRC_CPUSBCLR_BIT) >> ASC_HCLKRC_CPUSBCLR_POS;
}

__STATIC_INLINE void aonsysctrl_hclkrc_cpusbclr_setb(void)
{
    CS_AONSYSCTRL->HCLKRC = ASC_HCLKRC_CPUSBCLR_BIT;
}

__STATIC_INLINE uint8_t aonsysctrl_hclkrc_cpuswclr_getb(void)
{
    return (CS_AONSYSCTRL->HCLKRC & ASC_HCLKRC_CPUSWCLR_BIT) >> ASC_HCLKRC_CPUSWCLR_POS;
}

__STATIC_INLINE void aonsysctrl_hclkrc_cpuswclr_setb(void)
{
    CS_AONSYSCTRL->HCLKRC = ASC_HCLKRC_CPUSWCLR_BIT;
}

__STATIC_INLINE uint8_t aonsysctrl_hclkrc_dspclr_getb(void)
{
    return (CS_AONSYSCTRL->HCLKRC & ASC_HCLKRC_DSPCLR_BIT) >> ASC_HCLKRC_DSPCLR_POS;
}

__STATIC_INLINE void aonsysctrl_hclkrc_dspclr_setb(void)
{
    CS_AONSYSCTRL->HCLKRC = ASC_HCLKRC_DSPCLR_BIT;
}
...
{
    return CS_AONSYSCTRL->OCLKRS;
}

__STATIC_INLINE void aonsysctrl_oclkrs_set(uint32_t reset_bits)
{
    CS_AONSYSCTRL->OCLKRS = reset_bits;
}

__STATIC_INLINE uint8_t aonsysctrl_oclkrs_32kwifiaonset_getb(void)
{
    return (CS_AONSYSCTRL->OCLKRS & ASC_OCLKRS_32KWIFIAONSET_BIT) >> ASC_OCLKRS_32KWIFIAONSET_POS;
}

__STATIC_INLINE void aonsysctrl_oclkrs_32kwifiaonset_setb(void)
{
    CS_AONSYSCTRL->OCLKRS = ASC_OCLKRS_32KWIFIAONSET_BIT;
}

__STATIC_INLINE uint8_t aonsysctrl_oclkrs_32kbtaonset_getb(void)
{
    return (CS_AONSYSCTRL->OCLKRS & ASC_OCLKRS_32KBTAONSET_BIT) >> ASC_OCLKRS_32KBTAONSET_POS;
}

__STATIC_INLINE void aonsysctrl_oclkrs_32kbtaonset_setb(void)
{
    CS_AONSYSCTRL->OCLKRS = ASC_OCLKRS_32KBTAONSET_BIT;
}

__STATIC_INLINE uint8_t aonsysctrl_oclkrs_cpuaonset_getb(void)
{
    return (CS_AONSYSCTRL->OCLKRS & ASC_OCLKRS_CPUAONSET_BIT) >> ASC_OCLKRS_CPUAONSET_POS;
}

__STATIC_INLINE void aonsysctrl_oclkrs_cpuaonset_setb(void)
{
    CS_AONSYSCTRL->OCLKRS = ASC_OCLKRS_CPUAONSET_BIT;
}
...
{
    return CS_AONSYSCTRL->OCLKRC;
}

__STATIC_INLINE void aonsysctrl_oclkrc_set(uint32_t reset_bits)
{
    CS_AONSYSCTRL->OCLKRC = reset_bits;
}

__STATIC_INLINE uint8_t aonsysctrl_oclkrc_32kwifiaonclr_getb(void)
{
    return (CS_AONSYSCTRL->OCLKRC & ASC_OCLKRC_32KWIFIAONCLR_BIT) >> ASC_OCLKRC_32KWIFIAONCLR_POS;
}

__STATIC_INLINE void aonsysctrl_oclkrc_32kwifiaonclr_setb(void)
{
    CS_AONSYSCTRL->OCLKRC = ASC_OCLKRC_32KWIFIAONCLR_BIT;
}

__STATIC_INLINE uint8_t aonsysctrl_oclkrc_32kbtaonclr_getb(void)
{
    return (CS_AONSYSCTRL->OCLKRC & ASC_OCLKRC_32KBTAONCLR_BIT) >> ASC_OCLKRC_32KBTAONCLR_POS;
}

__STATIC_INLINE void aonsysctrl_oclkrc_32kbtaonclr_setb(void)
{
    CS_AONSYSCTRL->OCLKRC = ASC_OCLKRC_32KBTAONCLR_BIT;
}

__STATIC_INLINE uint8_t aonsysctrl_oclkrc_cpuaonclr_getb(void)
{
    return (CS_AONSYSCTRL->OCLKRC & ASC_OCLKRC_CPUAONCLR_BIT) >> ASC_OCLKRC_CPUAONCLR_POS;
}

__STATIC_INLINE void aonsysctrl_oclkrc_cpuaonclr_setb(void)
{
    CS_AONSYSCTRL->OCLKRC = ASC_OCLKRC_CPUAONCLR_BIT;
}
...
{
    return ((CS_AONSYSCTRL->BOOTMD & ASC_BOOTMD_HW_BOOT_MODE_MASK) >> ASC_BOOTMD_HW_BOOT_MODE_LSB);
}

__STATIC_INLINE void aonsysctrl_bootmd_hw_boot_mode_setf(uint8_t boot_mode)
{
    uint32_t local_val = CS_AONSYSCTRL->BOOTMD & ~ASC_BOOTMD_HW_BOOT_MODE_MASK;
    CS_AONSYSCTRL->BOOTMD = local_val | ((boot_mode << ASC_BOOTMD_HW_BOOT_MODE_LSB) & ASC_BOOTMD_HW_BOOT_MODE_MASK);
}

__STATIC_INLINE uint8_t aonsysctrl_bootmd_sw_boot_mode_getf(void)
{
    return ((CS_AONSYSCTRL->BOOTMD & ASC_BOOTMD_SW_BOOT_MODE_MASK) >> ASC_BOOTMD_SW_BOOT_MODE_LSB);
}

__STATIC_INLINE void aonsysctrl_bootmd_sw_boot_mode_setf(uint8_t boot_mode)
{
    uint32_t local_val = CS_AONSYSCTRL->BOOTMD & ~ASC_BOOTMD_SW_BOOT_MODE_MASK;
    CS_AONSYSCTRL->BOOTMD = local_val | ((boot_mode << ASC_BOOTMD_SW_BOOT_MODE_LSB) & ASC_BOOTMD_SW_BOOT_MODE_MASK);
}
...
{
    return ((CS_AONSYSCTRL->BTFWCTRL & ASC_BTFWCTRL_STACK_TOP_MASK) >> ASC_BTFWCTRL_STACK_TOP_LSB);
}

__STATIC_INLINE void aonsysctrl_btfwctrl_stack_top_setf(uint32_t addr)
{
    uint32_t local_val = CS_AONSYSCTRL->BTFWCTRL & ~ASC_BTFWCTRL_STACK_TOP_MASK;
    CS_AONSYSCTRL->BTFWCTRL = local_val | ((addr << ASC_BTFWCTRL_STACK_TOP_LSB) & ASC_BTFWCTRL_STACK_TOP_MASK) | ASC_BTFWCTRL_STACK_TOP_VALID_BIT;
}

__STATIC_INLINE uint32_t aonsysctrl_btfwctrl_btcore_swctrl_getf(void)
{
    return ((CS_AONSYSCTRL->BTFWCTRL & ASC_BTFWCTRL_BTCORE_SWCTRL_MASK) >> ASC_BTFWCTRL_BTCORE_SWCTRL_LSB);
}

__STATIC_INLINE void aonsysctrl_btfwctrl_btcore_swctrl_setf(uint32_t addr)
{
    uint32_t local_val = CS_AONSYSCTRL->BTFWCTRL & ~ASC_BTFWCTRL_BTCORE_SWCTRL_MASK;
    CS_AONSYSCTRL->BTFWCTRL = local_val | ((addr << ASC_BTFWCTRL_BTCORE_SWCTRL_LSB) & ASC_BTFWCTRL_BTCORE_SWCTRL_MASK);
}
...
{
    return ((CS_AONSYSCTRL->WIFIFWCTRL & ASC_WIFIFWCTRL_STACK_TOP_MASK) >> ASC_WIFIFWCTRL_STACK_TOP_LSB);
}

__STATIC_INLINE void aonsysctrl_wififwctrl_stack_top_setf(uint32_t addr)
{
    uint32_t local_val = CS_AONSYSCTRL->WIFIFWCTRL & ~ASC_WIFIFWCTRL_STACK_TOP_MASK;
    CS_AONSYSCTRL->WIFIFWCTRL = local_val | ((addr << ASC_WIFIFWCTRL_STACK_TOP_LSB) & ASC_WIFIFWCTRL_STACK_TOP_MASK) | ASC_WIFIFWCTRL_STACK_TOP_VALID_BIT;
}

__STATIC_INLINE uint32_t aonsysctrl_wififwctrl_wificore_swctrl_getf(void)
{
    return ((CS_AONSYSCTRL->WIFIFWCTRL & ASC_WIFIFWCTRL_WIFICORE_SWCTRL_MASK) >> ASC_WIFIFWCTRL_WIFICORE_SWCTRL_LSB);
}

__STATIC_INLINE void aonsysctrl_wififwctrl_wificore_swctrl_setf(uint32_t addr)
{
    uint32_t local_val = CS_AONSYSCTRL->WIFIFWCTRL & ~ASC_WIFIFWCTRL_WIFICORE_SWCTRL_MASK;
    CS_AONSYSCTRL->WIFIFWCTRL = local_val | ((addr << ASC_WIFIFWCTRL_WIFICORE_SWCTRL_LSB) & ASC_WIFIFWCTRL_WIFICORE_SWCTRL_MASK);
}
...
{
    return (CS_CPUSYSCTRL->CLKSEL & CSC_CLKSEL_FLASHCLK_BIT) >> CSC_CLKSEL_FLASHCLK_POS;
}

__STATIC_INLINE void cpusysctrl_flash_clk_setb(void)
{
    CS_CPUSYSCTRL->CLKSEL |=  CSC_CLKSEL_FLASHCLK_BIT;
}
...
{
    return (CS_CPUSYSCTRL->CLKSEL & CSC_CLKSEL_UART0CLK_BIT) >> CSC_CLKSEL_UART0CLK_POS;
}

__STATIC_INLINE void cpusysctrl_uart0_clk_setb(void)
{
    CS_CPUSYSCTRL->CLKSEL |=  CSC_CLKSEL_UART0CLK_BIT;
}
...
{
    return (CS_CPUSYSCTRL->CLKSEL & CSC_CLKSEL_UART1CLK_BIT) >> CSC_CLKSEL_UART1CLK_POS;
}

__STATIC_INLINE void cpusysctrl_uart1_clk_setb(void)
{
    CS_CPUSYSCTRL->CLKSEL |=  CSC_CLKSEL_UART1CLK_BIT;
}
...
{
    return (CS_CPUSYSCTRL->CLKSEL & CSC_CLKSEL_UART2CLK_BIT) >> CSC_CLKSEL_UART2CLK_POS;
}

__STATIC_INLINE void cpusysctrl_uart2_clk_setb(void)
{
    CS_CPUSYSCTRL->CLKSEL |=  CSC_CLKSEL_UART2CLK_BIT;
}
...
{
    return (CS_CPUSYSCTRL->CLKSEL >> (CSC_CLKSEL_UART0CLK_POS + idx)) & 0x01U;
}

__STATIC_INLINE uint8_t cpusysctrl_cameraref_clk_getb(void)
{
    return (CS_CPUSYSCTRL->CLKSEL & CSC_CLKSEL_CAMERAREFCLK_BIT) >> CSC_CLKSEL_CAMERAREFCLK_POS;
}

__STATIC_INLINE void cpusysctrl_cameraref_clk_setb(void)
{
    CS_CPUSYSCTRL->CLKSEL |=  CSC_CLKSEL_CAMERAREFCLK_BIT;
}
...
{
    return (CS_CPUSYSCTRL->CLKSEL & CSC_CLKSEL_ASDMACLK_BIT) >> CSC_CLKSEL_ASDMACLK_POS;
}
...
{
    return (CS_CPUSYSCTRL->CACHEBP & CSC_CACHEBP_BURST_INCR_ONLY_EN_BIT) >> CSC_CACHEBP_BURST_INCR_ONLY_EN_POS;
}

__STATIC_INLINE void cpusysctrl_cachebp_burst_incr_only_en_setb(void)
{
    CS_CPUSYSCTRL->CACHEBP |=  CSC_CACHEBP_BURST_INCR_ONLY_EN_BIT;
}
...
{
    return (CS_CPUSYSCTRL->PSRMDSEL & CSC_PSRMDSEL_UHSMD_BIT) >> CSC_PSRMDSEL_UHSMD_POS;
}

__STATIC_INLINE void cpusysctrl_psrmdsel_uhsmd_setb(void)
{
    CS_CPUSYSCTRL->PSRMDSEL |=  CSC_PSRMDSEL_UHSMD_BIT;
}
...
{
    return ((CS_CPUSYSCTRL->PCLKDIV & CSC_PCLKDIV_DENOM_MASK) >> CSC_PCLKDIV_DENOM_LSB);
}

__STATIC_INLINE void cpusysctrl_pclkdiv_denom_setf(uint8_t div_denom)
{
    uint32_t local_val = CS_CPUSYSCTRL->PCLKDIV & ~CSC_PCLKDIV_DENOM_MASK;
    CS_CPUSYSCTRL->PCLKDIV = local_val | ((div_denom << CSC_PCLKDIV_DENOM_LSB) & CSC_PCLKDIV_DENOM_MASK) | CSC_PCLKDIV_UPDATE_BIT;
}
...
{
    return ((CS_CPUSYSCTRL->ULPICD & CSC_ULPICD_CLKDETTH_MASK) >> CSC_ULPICD_CLKDETTH_LSB);
}

__STATIC_INLINE void cpusysctrl_ulpicd_clkdetth_setf(uint8_t clkdet_th)
{
    uint32_t local_val = CS_CPUSYSCTRL->ULPICD & ~CSC_ULPICD_CLKDETTH_MASK;
    CS_CPUSYSCTRL->ULPICD = local_val | ((clkdet_th << CSC_ULPICD_CLKDETTH_LSB) & CSC_ULPICD_CLKDETTH_MASK) | CSC_ULPICD_CLKDETEN_BIT;
}
...
{
    return CS_CPUSYSCTRL->ULPICS;
}

__STATIC_INLINE uint8_t cpusysctrl_ulpics_clkst_getf(void)
{
    return ((CS_CPUSYSCTRL->ULPICS & CSC_ULPICS_CLKST_BIT) >> CSC_ULPICS_CLKST_POS);
}
...
{
    return CS_CPUSYSCTRL->HCLKRS;
}

__STATIC_INLINE void cpusysctrl_hclkrs_set(uint32_t reset_bits)
{
    CS_CPUSYSCTRL->HCLKRS = reset_bits;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrs_cpupset_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRS & CSC_HCLKRS_CPUPSET_BIT) >> CSC_HCLKRS_CPUPSET_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrs_cpupset_setb(void)
{
    CS_CPUSYSCTRL->HCLKRS = CSC_HCLKRS_CPUPSET_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrs_romset_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRS & CSC_HCLKRS_ROMSET_BIT) >> CSC_HCLKRS_ROMSET_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrs_romset_setb(void)
{
    CS_CPUSYSCTRL->HCLKRS = CSC_HCLKRS_ROMSET_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrs_sram0set_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRS & CSC_HCLKRS_SRAM0SET_BIT) >> CSC_HCLKRS_SRAM0SET_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrs_sram0set_setb(void)
{
    CS_CPUSYSCTRL->HCLKRS = CSC_HCLKRS_SRAM0SET_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrs_sram1set_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRS & CSC_HCLKRS_SRAM1SET_BIT) >> CSC_HCLKRS_SRAM1SET_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrs_sram1set_setb(void)
{
    CS_CPUSYSCTRL->HCLKRS = CSC_HCLKRS_SRAM1SET_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrs_sram2set_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRS & CSC_HCLKRS_SRAM2SET_BIT) >> CSC_HCLKRS_SRAM2SET_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrs_sram2set_setb(void)
{
    CS_CPUSYSCTRL->HCLKRS = CSC_HCLKRS_SRAM2SET_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrs_sram3set_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRS & CSC_HCLKRS_SRAM3SET_BIT) >> CSC_HCLKRS_SRAM3SET_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrs_sram3set_setb(void)
{
    CS_CPUSYSCTRL->HCLKRS = CSC_HCLKRS_SRAM3SET_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrs_sram4set_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRS & CSC_HCLKRS_SRAM4SET_BIT) >> CSC_HCLKRS_SRAM4SET_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrs_sram4set_setb(void)
{
    CS_CPUSYSCTRL->HCLKRS = CSC_HCLKRS_SRAM4SET_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrs_sram5set_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRS & CSC_HCLKRS_SRAM5SET_BIT) >> CSC_HCLKRS_SRAM5SET_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrs_sram5set_setb(void)
{
    CS_CPUSYSCTRL->HCLKRS = CSC_HCLKRS_SRAM5SET_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrs_ahb0decset_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRS & CSC_HCLKRS_AHB0DECSET_BIT) >> CSC_HCLKRS_AHB0DECSET_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrs_ahb0decset_setb(void)
{
    CS_CPUSYSCTRL->HCLKRS = CSC_HCLKRS_AHB0DECSET_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrs_ahb1decset_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRS & CSC_HCLKRS_AHB1DECSET_BIT) >> CSC_HCLKRS_AHB1DECSET_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrs_ahb1decset_setb(void)
{
    CS_CPUSYSCTRL->HCLKRS = CSC_HCLKRS_AHB1DECSET_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrs_apb0set_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRS & CSC_HCLKRS_APB0SET_BIT) >> CSC_HCLKRS_APB0SET_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrs_apb0set_setb(void)
{
    CS_CPUSYSCTRL->HCLKRS = CSC_HCLKRS_APB0SET_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrs_flashset_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRS & CSC_HCLKRS_FLASHSET_BIT) >> CSC_HCLKRS_FLASHSET_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrs_flashset_setb(void)
{
    CS_CPUSYSCTRL->HCLKRS = CSC_HCLKRS_FLASHSET_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrs_dmaset_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRS & CSC_HCLKRS_DMASET_BIT) >> CSC_HCLKRS_DMASET_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrs_dmaset_setb(void)
{
    CS_CPUSYSCTRL->HCLKRS = CSC_HCLKRS_DMASET_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrs_exmembusset_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRS & CSC_HCLKRS_EXMEMBUSSET_BIT) >> CSC_HCLKRS_EXMEMBUSSET_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrs_exmembusset_setb(void)
{
    CS_CPUSYSCTRL->HCLKRS = CSC_HCLKRS_EXMEMBUSSET_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrs_cache0set_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRS & CSC_HCLKRS_CACHE0SET_BIT) >> CSC_HCLKRS_CACHE0SET_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrs_cache0set_setb(void)
{
    CS_CPUSYSCTRL->HCLKRS = CSC_HCLKRS_CACHE0SET_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrs_cache1set_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRS & CSC_HCLKRS_CACHE1SET_BIT) >> CSC_HCLKRS_CACHE1SET_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrs_cache1set_setb(void)
{
    CS_CPUSYSCTRL->HCLKRS = CSC_HCLKRS_CACHE1SET_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrs_psramset_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRS & CSC_HCLKRS_PSRAMSET_BIT) >> CSC_HCLKRS_PSRAMSET_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrs_psramset_setb(void)
{
    CS_CPUSYSCTRL->HCLKRS = CSC_HCLKRS_PSRAMSET_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrs_psramregset_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRS & CSC_HCLKRS_PSRAMREGSET_BIT) >> CSC_HCLKRS_PSRAMREGSET_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrs_psramregset_setb(void)
{
    CS_CPUSYSCTRL->HCLKRS = CSC_HCLKRS_PSRAMREGSET_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrs_trapset_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRS & CSC_HCLKRS_TRAPSET_BIT) >> CSC_HCLKRS_TRAPSET_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrs_trapset_setb(void)
{
    CS_CPUSYSCTRL->HCLKRS = CSC_HCLKRS_TRAPSET_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrs_uart0set_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRS & CSC_HCLKRS_UART0SET_BIT) >> CSC_HCLKRS_UART0SET_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrs_uart0set_setb(void)
{
    CS_CPUSYSCTRL->HCLKRS = CSC_HCLKRS_UART0SET_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrs_uart1set_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRS & CSC_HCLKRS_UART1SET_BIT) >> CSC_HCLKRS_UART1SET_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrs_uart1set_setb(void)
{
    CS_CPUSYSCTRL->HCLKRS = CSC_HCLKRS_UART1SET_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrs_uart2set_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRS & CSC_HCLKRS_UART2SET_BIT) >> CSC_HCLKRS_UART2SET_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrs_uart2set_setb(void)
{
    CS_CPUSYSCTRL->HCLKRS = CSC_HCLKRS_UART2SET_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrs_usbcset_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRS & CSC_HCLKRS_USBCSET_BIT) >> CSC_HCLKRS_USBCSET_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrs_usbcset_setb(void)
{
    CS_CPUSYSCTRL->HCLKRS = CSC_HCLKRS_USBCSET_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrs_vpcset_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRS & CSC_HCLKRS_VPCSET_BIT) >> CSC_HCLKRS_VPCSET_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrs_vpcset_setb(void)
{
    CS_CPUSYSCTRL->HCLKRS = CSC_HCLKRS_VPCSET_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrs_mailboxset_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRS & CSC_HCLKRS_MAILBOXSET_BIT) >> CSC_HCLKRS_MAILBOXSET_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrs_mailboxset_setb(void)
{
    CS_CPUSYSCTRL->HCLKRS = CSC_HCLKRS_MAILBOXSET_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrs_asdmaset_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRS & CSC_HCLKRS_ASDMASET_BIT) >> CSC_HCLKRS_ASDMASET_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrs_asdmaset_setb(void)
{
    CS_CPUSYSCTRL->HCLKRS = CSC_HCLKRS_ASDMASET_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrs_sdioset_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRS & CSC_HCLKRS_SDIOSET_BIT) >> CSC_HCLKRS_SDIOSET_POS;
}
...
{
    return (CS_CPUSYSCTRL->HCLKRS & CSC_HCLKRS_CAMERASET_BIT) >> CSC_HCLKRS_CAMERASET_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrs_cameraset_setb(void)
{
    CS_CPUSYSCTRL->HCLKRS = CSC_HCLKRS_CAMERASET_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrs_sram6set_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRS & CSC_HCLKRS_SRAM6SET_BIT) >> CSC_HCLKRS_SRAM6SET_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrs_sram6set_setb(void)
{
    CS_CPUSYSCTRL->HCLKRS = CSC_HCLKRS_SRAM6SET_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrs_jpegencset_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRS & CSC_HCLKRS_JPEGENCSET_BIT) >> CSC_HCLKRS_JPEGENCSET_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrs_jpegencset_setb(void)
{
    CS_CPUSYSCTRL->HCLKRS = CSC_HCLKRS_JPEGENCSET_BIT;
}
...
{
    return CS_CPUSYSCTRL->HCLKRC;
}

__STATIC_INLINE void cpusysctrl_hclkrc_set(uint32_t reset_bits)
{
    CS_CPUSYSCTRL->HCLKRC = reset_bits;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrc_cpupclr_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRC & CSC_HCLKRC_CPUPCLR_BIT) >> CSC_HCLKRC_CPUPCLR_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrc_cpupclr_setb(void)
{
    CS_CPUSYSCTRL->HCLKRC = CSC_HCLKRC_CPUPCLR_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrc_romclr_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRC & CSC_HCLKRC_ROMCLR_BIT) >> CSC_HCLKRC_ROMCLR_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrc_romclr_setb(void)
{
    CS_CPUSYSCTRL->HCLKRC = CSC_HCLKRC_ROMCLR_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrc_sram0clr_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRC & CSC_HCLKRC_SRAM0CLR_BIT) >> CSC_HCLKRC_SRAM0CLR_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrc_sram0clr_setb(void)
{
    CS_CPUSYSCTRL->HCLKRC = CSC_HCLKRC_SRAM0CLR_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrc_sram1clr_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRC & CSC_HCLKRC_SRAM1CLR_BIT) >> CSC_HCLKRC_SRAM1CLR_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrc_sram1clr_setb(void)
{
    CS_CPUSYSCTRL->HCLKRC = CSC_HCLKRC_SRAM1CLR_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrc_sram2clr_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRC & CSC_HCLKRC_SRAM2CLR_BIT) >> CSC_HCLKRC_SRAM2CLR_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrc_sram2clr_setb(void)
{
    CS_CPUSYSCTRL->HCLKRC = CSC_HCLKRC_SRAM2CLR_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrc_sram3clr_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRC & CSC_HCLKRC_SRAM3CLR_BIT) >> CSC_HCLKRC_SRAM3CLR_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrc_sram3clr_setb(void)
{
    CS_CPUSYSCTRL->HCLKRC = CSC_HCLKRC_SRAM3CLR_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrc_sram4clr_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRC & CSC_HCLKRC_SRAM4CLR_BIT) >> CSC_HCLKRC_SRAM4CLR_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrc_sram4clr_setb(void)
{
    CS_CPUSYSCTRL->HCLKRC = CSC_HCLKRC_SRAM4CLR_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrc_sram5clr_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRC & CSC_HCLKRC_SRAM5CLR_BIT) >> CSC_HCLKRC_SRAM5CLR_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrc_sram5clr_setb(void)
{
    CS_CPUSYSCTRL->HCLKRC = CSC_HCLKRC_SRAM5CLR_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrc_ahb0decclr_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRC & CSC_HCLKRC_AHB0DECCLR_BIT) >> CSC_HCLKRC_AHB0DECCLR_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrc_ahb0decclr_setb(void)
{
    CS_CPUSYSCTRL->HCLKRC = CSC_HCLKRC_AHB0DECCLR_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrc_ahb1decclr_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRC & CSC_HCLKRC_AHB1DECCLR_BIT) >> CSC_HCLKRC_AHB1DECCLR_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrc_ahb1decclr_setb(void)
{
    CS_CPUSYSCTRL->HCLKRC = CSC_HCLKRC_AHB1DECCLR_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrc_apb0clr_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRC & CSC_HCLKRC_APB0CLR_BIT) >> CSC_HCLKRC_APB0CLR_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrc_apb0clr_setb(void)
{
    CS_CPUSYSCTRL->HCLKRC = CSC_HCLKRC_APB0CLR_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrc_flashclr_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRC & CSC_HCLKRC_FLASHCLR_BIT) >> CSC_HCLKRC_FLASHCLR_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrc_flashclr_setb(void)
{
    CS_CPUSYSCTRL->HCLKRC = CSC_HCLKRC_FLASHCLR_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrc_dmaclr_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRC & CSC_HCLKRC_DMACLR_BIT) >> CSC_HCLKRC_DMACLR_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrc_dmaclr_setb(void)
{
    CS_CPUSYSCTRL->HCLKRC = CSC_HCLKRC_DMACLR_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrc_exmembusclr_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRC & CSC_HCLKRC_EXMEMBUSCLR_BIT) >> CSC_HCLKRC_EXMEMBUSCLR_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrc_exmembusclr_setb(void)
{
    CS_CPUSYSCTRL->HCLKRC = CSC_HCLKRC_EXMEMBUSCLR_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrc_cache0clr_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRC & CSC_HCLKRC_CACHE0CLR_BIT) >> CSC_HCLKRC_CACHE0CLR_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrc_cache0clr_setb(void)
{
    CS_CPUSYSCTRL->HCLKRC = CSC_HCLKRC_CACHE0CLR_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrc_cache1clr_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRC & CSC_HCLKRC_CACHE1CLR_BIT) >> CSC_HCLKRC_CACHE1CLR_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrc_cache1clr_setb(void)
{
    CS_CPUSYSCTRL->HCLKRC = CSC_HCLKRC_CACHE1CLR_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrc_psramclr_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRC & CSC_HCLKRC_PSRAMCLR_BIT) >> CSC_HCLKRC_PSRAMCLR_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrc_psramclr_setb(void)
{
    CS_CPUSYSCTRL->HCLKRC = CSC_HCLKRC_PSRAMCLR_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrc_psramregclr_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRC & CSC_HCLKRC_PSRAMREGCLR_BIT) >> CSC_HCLKRC_PSRAMREGCLR_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrc_psramregclr_setb(void)
{
    CS_CPUSYSCTRL->HCLKRC = CSC_HCLKRC_PSRAMREGCLR_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrc_trapclr_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRC & CSC_HCLKRC_TRAPCLR_BIT) >> CSC_HCLKRC_TRAPCLR_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrc_trapclr_setb(void)
{
    CS_CPUSYSCTRL->HCLKRC = CSC_HCLKRC_TRAPCLR_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrc_uart0clr_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRC & CSC_HCLKRC_UART0CLR_BIT) >> CSC_HCLKRC_UART0CLR_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrc_uart0clr_setb(void)
{
    CS_CPUSYSCTRL->HCLKRC = CSC_HCLKRC_UART0CLR_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrc_uart1clr_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRC & CSC_HCLKRC_UART1CLR_BIT) >> CSC_HCLKRC_UART1CLR_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrc_uart1clr_setb(void)
{
    CS_CPUSYSCTRL->HCLKRC = CSC_HCLKRC_UART1CLR_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrc_uart2clr_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRC & CSC_HCLKRC_UART2CLR_BIT) >> CSC_HCLKRC_UART2CLR_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrc_uart2clr_setb(void)
{
    CS_CPUSYSCTRL->HCLKRC = CSC_HCLKRC_UART2CLR_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrc_usbcclr_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRC & CSC_HCLKRC_USBCCLR_BIT) >> CSC_HCLKRC_USBCCLR_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrc_usbcclr_setb(void)
{
    CS_CPUSYSCTRL->HCLKRC = CSC_HCLKRC_USBCCLR_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrc_vpcclr_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRC & CSC_HCLKRC_VPCCLR_BIT) >> CSC_HCLKRC_VPCCLR_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrc_vpcclr_setb(void)
{
    CS_CPUSYSCTRL->HCLKRC = CSC_HCLKRC_VPCCLR_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrc_mailboxclr_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRC & CSC_HCLKRC_MAILBOXCLR_BIT) >> CSC_HCLKRC_MAILBOXCLR_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrc_mailboxclr_setb(void)
{
    CS_CPUSYSCTRL->HCLKRC = CSC_HCLKRC_MAILBOXCLR_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrc_asdmaclr_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRC & CSC_HCLKRC_ASDMACLR_BIT) >> CSC_HCLKRC_ASDMACLR_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrc_asdmaclr_setb(void)
{
    CS_CPUSYSCTRL->HCLKRC = CSC_HCLKRC_ASDMACLR_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrc_sdioclr_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRC & CSC_HCLKRC_SDIOCLR_BIT) >> CSC_HCLKRC_SDIOCLR_POS;
}
...
{
    return (CS_CPUSYSCTRL->HCLKRC & CSC_HCLKRC_CAMERACLR_BIT) >> CSC_HCLKRC_CAMERACLR_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrc_cameraclr_setb(void)
{
    CS_CPUSYSCTRL->HCLKRC = CSC_HCLKRC_CAMERACLR_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrc_sram6clr_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRC & CSC_HCLKRC_SRAM6CLR_BIT) >> CSC_HCLKRC_SRAM6CLR_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrc_sram6clr_setb(void)
{
    CS_CPUSYSCTRL->HCLKRC = CSC_HCLKRC_SRAM6CLR_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_hclkrc_jpegencclr_getb(void)
{
    return (CS_CPUSYSCTRL->HCLKRC & CSC_HCLKRC_JPEGENCCLR_BIT) >> CSC_HCLKRC_JPEGENCCLR_POS;
}

__STATIC_INLINE void cpusysctrl_hclkrc_jpegencclr_setb(void)
{
    CS_CPUSYSCTRL->HCLKRC = CSC_HCLKRC_JPEGENCCLR_BIT;
}
...
{
    return CS_CPUSYSCTRL->PCLKRS;
}

__STATIC_INLINE void cpusysctrl_pclkrs_set(uint32_t reset_bits)
{
    CS_CPUSYSCTRL->PCLKRS = reset_bits;
}

__STATIC_INLINE uint8_t cpusysctrl_pclkrs_cpusysctrlset_getb(void)
{
    return (CS_CPUSYSCTRL->PCLKRS & CSC_PCLKRS_CPUSYSCTRLSET_BIT) >> CSC_PCLKRS_CPUSYSCTRLSET_POS;
}

__STATIC_INLINE void cpusysctrl_pclkrs_cpusysctrlset_setb(void)
{
    CS_CPUSYSCTRL->PCLKRS = CSC_PCLKRS_CPUSYSCTRLSET_BIT;
}
...
{
    return CS_CPUSYSCTRL->PCLKRC;
}

__STATIC_INLINE void cpusysctrl_pclkrc_set(uint32_t reset_bits)
{
    CS_CPUSYSCTRL->PCLKRC = reset_bits;
}

__STATIC_INLINE uint8_t cpusysctrl_pclkrc_cpusysctrlclr_getb(void)
{
    return (CS_CPUSYSCTRL->PCLKRC & CSC_PCLKRC_CPUSYSCTRLCLR_BIT) >> CSC_PCLKRC_CPUSYSCTRLCLR_POS;
}

__STATIC_INLINE void cpusysctrl_pclkrc_cpusysctrlclr_setb(void)
{
    CS_CPUSYSCTRL->PCLKRC = CSC_PCLKRC_CPUSYSCTRLCLR_BIT;
}
...
{
    return CS_CPUSYSCTRL->OCLKRS;
}

__STATIC_INLINE void cpusysctrl_oclkrs_set(uint32_t reset_bits)
{
    CS_CPUSYSCTRL->OCLKRS = reset_bits;
}

__STATIC_INLINE uint8_t cpusysctrl_oclkrs_sdioset_getb(void)
{
    return (CS_CPUSYSCTRL->OCLKRS & CSC_OCLKRS_SDIOSET_BIT) >> CSC_OCLKRS_SDIOSET_POS;
}

__STATIC_INLINE void cpusysctrl_oclkrs_sdioset_setb(void)
{
    CS_CPUSYSCTRL->OCLKRS = CSC_OCLKRS_SDIOSET_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_oclkrs_asdmaset_getb(void)
{
    return (CS_CPUSYSCTRL->OCLKRS & CSC_OCLKRS_ASDMASET_BIT) >> CSC_OCLKRS_ASDMASET_POS;
}

__STATIC_INLINE void cpusysctrl_oclkrs_asdmaset_setb(void)
{
    CS_CPUSYSCTRL->OCLKRS = CSC_OCLKRS_ASDMASET_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_oclkrs_ulpiset_getb(void)
{
    return (CS_CPUSYSCTRL->OCLKRS & CSC_OCLKRS_ULPISET_BIT) >> CSC_OCLKRS_ULPISET_POS;
}

__STATIC_INLINE void cpusysctrl_oclkrs_ulpiset_setb(void)
{
    CS_CPUSYSCTRL->OCLKRS = CSC_OCLKRS_ULPISET_BIT;
}
...
{
    return CS_CPUSYSCTRL->OCLKRC;
}

__STATIC_INLINE void cpusysctrl_oclkrc_set(uint32_t reset_bits)
{
    CS_CPUSYSCTRL->OCLKRC = reset_bits;
}

__STATIC_INLINE uint8_t cpusysctrl_oclkrc_sdioclr_getb(void)
{
    return (CS_CPUSYSCTRL->OCLKRC & CSC_OCLKRC_SDIOCLR_BIT) >> CSC_OCLKRC_SDIOCLR_POS;
}

__STATIC_INLINE void cpusysctrl_oclkrc_sdioclr_setb(void)
{
    CS_CPUSYSCTRL->OCLKRC = CSC_OCLKRC_SDIOCLR_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_oclkrc_asdmaclr_getb(void)
{
    return (CS_CPUSYSCTRL->OCLKRC & CSC_OCLKRC_ASDMACLR_BIT) >> CSC_OCLKRC_ASDMACLR_POS;
}

__STATIC_INLINE void cpusysctrl_oclkrc_asdmaclr_setb(void)
{
    CS_CPUSYSCTRL->OCLKRC = CSC_OCLKRC_ASDMACLR_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_oclkrc_ulpiclr_getb(void)
{
    return (CS_CPUSYSCTRL->OCLKRC & CSC_OCLKRC_ULPICLR_BIT) >> CSC_OCLKRC_ULPICLR_POS;
}

__STATIC_INLINE void cpusysctrl_oclkrc_ulpiclr_setb(void)
{
    CS_CPUSYSCTRL->OCLKRC = CSC_OCLKRC_ULPICLR_BIT;
}
...
{
    return CS_PWRCTRL->CPUSYS;
}

__STATIC_INLINE void pwrctrl_cpusys_set(uint32_t reg_val)
{
    CS_PWRCTRL->CPUSYS = reg_val;
}

__STATIC_INLINE uint16_t pwrctrl_cpusys_awake_src_getf(void)
{
    return ((CS_PWRCTRL->CPUSYS & PC_CPUSYS_AWAKE_SRC_MASK) >> PC_CPUSYS_AWAKE_SRC_LSB);
}

__STATIC_INLINE void pwrctrl_cpusys_awake_src_setf(uint16_t awake_src)
{
    uint32_t local_val = CS_PWRCTRL->CPUSYS & ~PC_CPUSYS_AWAKE_SRC_MASK;
    CS_PWRCTRL->CPUSYS = local_val | ((awake_src << PC_CPUSYS_AWAKE_SRC_LSB) & PC_CPUSYS_AWAKE_SRC_MASK);
}

__STATIC_INLINE uint16_t pwrctrl_cpusys_sleep_src_getf(void)
{
    return ((CS_PWRCTRL->CPUSYS & PC_CPUSYS_SLEEP_SRC_MASK) >> PC_CPUSYS_SLEEP_SRC_LSB);
}

__STATIC_INLINE void pwrctrl_cpusys_sleep_src_setf(uint16_t awake_src)
{
    uint32_t local_val = CS_PWRCTRL->CPUSYS & ~PC_CPUSYS_SLEEP_SRC_MASK;
    CS_PWRCTRL->CPUSYS = local_val | ((awake_src << PC_CPUSYS_SLEEP_SRC_LSB) & PC_CPUSYS_SLEEP_SRC_MASK);
}

__STATIC_INLINE uint8_t pwrctrl_cpusys_sleep_src_wifi_getb(void)
{
    return (CS_PWRCTRL->CPUSYS & PC_CPUSYS_SLEEP_SRC_WIFI_BIT) >> PC_CPUSYS_SLEEP_SRC_WIFI_POS;
}

__STATIC_INLINE void pwrctrl_cpusys_sleep_src_wifi_setb(void)
{
    CS_PWRCTRL->CPUSYS |=  PC_CPUSYS_SLEEP_SRC_WIFI_BIT;
}
...
{
    return (CS_PWRCTRL->CPUSYS & PC_CPUSYS_SLEEP_SRC_BT_BIT) >> PC_CPUSYS_SLEEP_SRC_BT_POS;
}

__STATIC_INLINE void pwrctrl_cpusys_sleep_src_bt_setb(void)
{
    CS_PWRCTRL->CPUSYS |=  PC_CPUSYS_SLEEP_SRC_BT_BIT;
}
...
{
    return (CS_PWRCTRL->CPUSYS & PC_CPUSYS_SLEEP_SOFT_REQ_BIT) >> PC_CPUSYS_SLEEP_SOFT_REQ_POS;
}

__STATIC_INLINE void pwrctrl_cpusys_sleep_soft_req_setb(void)
{
    CS_PWRCTRL->CPUSYS |=  PC_CPUSYS_SLEEP_SOFT_REQ_BIT;
}

__STATIC_INLINE uint8_t pwrctrl_cpusys_sleep_req_vld_clr_getb(void)
{
    return (CS_PWRCTRL->CPUSYS & PC_CPUSYS_SLEEP_REQVLDCLR_BIT) >> PC_CPUSYS_SLEEP_REQVLDCLR_POS;
}

__STATIC_INLINE void pwrctrl_cpusys_sleep_req_vld_clr_setb(void)
{
    CS_PWRCTRL->CPUSYS |=  PC_CPUSYS_SLEEP_REQVLDCLR_BIT;
}

__STATIC_INLINE uint8_t pwrctrl_cpusys_hwen_pon_getb(void)
{
    return (CS_PWRCTRL->CPUSYS & PC_CPUSYS_HWEN_PON_BIT) >> PC_CPUSYS_HWEN_PON_POS;
}

__STATIC_INLINE void pwrctrl_cpusys_hwen_pon_setb(void)
{
    CS_PWRCTRL->CPUSYS |=  PC_CPUSYS_HWEN_PON_BIT;
}
...
{
    CS_PWRCTRL->CPUSYS |=  PC_CPUSYS_HWEN_POFF_BIT;
}
...
{
    return (CS_PWRCTRL->CPUSYS & PC_CPUSYS_PON_BIT) >> PC_CPUSYS_PON_POS;
}

__STATIC_INLINE void pwrctrl_cpusys_pon_setb(void)
{
    CS_PWRCTRL->CPUSYS |=  PC_CPUSYS_PON_BIT;
}
...
{
    return (CS_PWRCTRL->CPUSYS & PC_CPUSYS_POFF_BIT) >> PC_CPUSYS_POFF_POS;
}

__STATIC_INLINE void pwrctrl_cpusys_poff_setb(void)
{
    CS_PWRCTRL->CPUSYS |=  PC_CPUSYS_POFF_BIT;
}
...
{
    return (CS_PWRCTRL->CPUSYS & PC_CPUSYS_PWRSYS_TMR_POFF_BIT) >> PC_CPUSYS_PWRSYS_TMR_POFF_POS;
}

__STATIC_INLINE void pwrctrl_cpusys_pwrsys_timer_poff_setb(void)
{
    CS_PWRCTRL->CPUSYS |=  PC_CPUSYS_PWRSYS_TMR_POFF_BIT;
}
...
{
    return (CS_PWRCTRL->CPUSYS & PC_CPUSYS_PWRSYS_PON_BIT) >> PC_CPUSYS_PWRSYS_PON_POS;
}

__STATIC_INLINE void pwrctrl_cpusys_pwrsys_pon_setb(void)
{
    CS_PWRCTRL->CPUSYS |=  PC_CPUSYS_PWRSYS_PON_BIT;
}
...
{
    return (CS_PWRCTRL->CPUSYS & PC_CPUSYS_PWRSYS_POFF_BIT) >> PC_CPUSYS_PWRSYS_POFF_POS;
}

__STATIC_INLINE void pwrctrl_cpusys_pwrsys_poff_setb(void)
{
    CS_PWRCTRL->CPUSYS |=  PC_CPUSYS_PWRSYS_POFF_BIT;
}
...
{
    return (CS_PWRCTRL->CPUSYS & PC_CPUSYS_AWAKE_SOFT_REQ_BIT) >> PC_CPUSYS_AWAKE_SOFT_REQ_POS;
}

__STATIC_INLINE void pwrctrl_cpusys_awake_soft_req_setb(void)
{
    CS_PWRCTRL->CPUSYS |=  PC_CPUSYS_AWAKE_SOFT_REQ_BIT;
}

__STATIC_INLINE uint8_t pwrctrl_cpusys_awake_req_vld_clr_getb(void)
{
    return (CS_PWRCTRL->CPUSYS & PC_CPUSYS_AWAKE_REQVLDCLR_BIT) >> PC_CPUSYS_AWAKE_REQVLDCLR_POS;
}

__STATIC_INLINE void pwrctrl_cpusys_awake_req_vld_clr_setb(void)
{
    CS_PWRCTRL->CPUSYS |=  PC_CPUSYS_AWAKE_REQVLDCLR_BIT;
}
...
{
    return CS_PWRCTRL->BTCORE;
}

__STATIC_INLINE void pwrctrl_btcore_set(uint32_t reg_val)
{
    CS_PWRCTRL->BTCORE = reg_val;
}

__STATIC_INLINE uint16_t pwrctrl_btcore_awake_src_getf(void)
{
    return ((CS_PWRCTRL->BTCORE & PC_BTCORE_AWAKE_SRC_MASK) >> PC_BTCORE_AWAKE_SRC_LSB);
}

__STATIC_INLINE void pwrctrl_btcore_awake_src_setf(uint16_t awake_src)
{
    uint32_t local_val = CS_PWRCTRL->BTCORE & ~PC_BTCORE_AWAKE_SRC_MASK;
    CS_PWRCTRL->BTCORE = local_val | ((awake_src << PC_BTCORE_AWAKE_SRC_LSB) & PC_BTCORE_AWAKE_SRC_MASK);
}

__STATIC_INLINE uint16_t pwrctrl_btcore_sleep_src_getf(void)
{
    return ((CS_PWRCTRL->BTCORE & PC_BTCORE_SLEEP_SRC_MASK) >> PC_BTCORE_SLEEP_SRC_LSB);
}

__STATIC_INLINE void pwrctrl_btcore_sleep_src_setf(uint16_t awake_src)
{
    uint32_t local_val = CS_PWRCTRL->BTCORE & ~PC_BTCORE_SLEEP_SRC_MASK;
    CS_PWRCTRL->BTCORE = local_val | ((awake_src << PC_BTCORE_SLEEP_SRC_LSB) & PC_BTCORE_SLEEP_SRC_MASK);
}

__STATIC_INLINE uint8_t pwrctrl_btcore_sleep_src_wifi_getb(void)
{
    return (CS_PWRCTRL->BTCORE & PC_BTCORE_SLEEP_SRC_WIFI_BIT) >> PC_BTCORE_SLEEP_SRC_WIFI_POS;
}

__STATIC_INLINE void pwrctrl_btcore_sleep_src_wifi_setb(void)
{
    CS_PWRCTRL->BTCORE |=  PC_BTCORE_SLEEP_SRC_WIFI_BIT;
}
...
{
    return (CS_PWRCTRL->BTCORE & PC_BTCORE_SLEEP_SRC_BT_BIT) >> PC_BTCORE_SLEEP_SRC_BT_POS;
}

__STATIC_INLINE void pwrctrl_btcore_sleep_src_bt_setb(void)
{
    CS_PWRCTRL->BTCORE |=  PC_BTCORE_SLEEP_SRC_BT_BIT;
}
...
{
    return (CS_PWRCTRL->BTCORE & PC_BTCORE_SLEEP_SOFT_REQ_BIT) >> PC_BTCORE_SLEEP_SOFT_REQ_POS;
}

__STATIC_INLINE void pwrctrl_btcore_sleep_soft_req_setb(void)
{
    CS_PWRCTRL->BTCORE |=  PC_BTCORE_SLEEP_SOFT_REQ_BIT;
}

__STATIC_INLINE uint8_t pwrctrl_btcore_sleep_req_vld_clr_getb(void)
{
    return (CS_PWRCTRL->BTCORE & PC_BTCORE_SLEEP_REQVLDCLR_BIT) >> PC_BTCORE_SLEEP_REQVLDCLR_POS;
}

__STATIC_INLINE void pwrctrl_btcore_sleep_req_vld_clr_setb(void)
{
    CS_PWRCTRL->BTCORE |=  PC_BTCORE_SLEEP_REQVLDCLR_BIT;
}

__STATIC_INLINE uint8_t pwrctrl_btcore_hwen_pon_getb(void)
{
    return (CS_PWRCTRL->BTCORE & PC_BTCORE_HWEN_PON_BIT) >> PC_BTCORE_HWEN_PON_POS;
}

__STATIC_INLINE void pwrctrl_btcore_hwen_pon_setb(void)
{
    CS_PWRCTRL->BTCORE |=  PC_BTCORE_HWEN_PON_BIT;
}
...
{
    return (CS_PWRCTRL->BTCORE & PC_BTCORE_HWEN_POFF_BIT) >> PC_BTCORE_HWEN_POFF_POS;
}

__STATIC_INLINE void pwrctrl_btcore_hwen_poff_setb(void)
{
    CS_PWRCTRL->BTCORE |=  PC_BTCORE_HWEN_POFF_BIT;
}
...
{
    return (CS_PWRCTRL->BTCORE & PC_BTCORE_PON_BIT) >> PC_BTCORE_PON_POS;
}
...
{
    return (CS_PWRCTRL->BTCORE & PC_BTCORE_POFF_BIT) >> PC_BTCORE_POFF_POS;
}

__STATIC_INLINE void pwrctrl_btcore_poff_setb(void)
{
    CS_PWRCTRL->BTCORE |=  PC_BTCORE_POFF_BIT;
}
...
{
    return (CS_PWRCTRL->BTCORE & PC_BTCORE_PWRSYS_TMR_POFF_BIT) >> PC_BTCORE_PWRSYS_TMR_POFF_POS;
}

__STATIC_INLINE void pwrctrl_btcore_pwrsys_timer_poff_setb(void)
{
    CS_PWRCTRL->BTCORE |=  PC_BTCORE_PWRSYS_TMR_POFF_BIT;
}
...
{
    return (CS_PWRCTRL->BTCORE & PC_BTCORE_PWRSYS_PON_BIT) >> PC_BTCORE_PWRSYS_PON_POS;
}
...
{
    return (CS_PWRCTRL->BTCORE & PC_BTCORE_PWRSYS_POFF_BIT) >> PC_BTCORE_PWRSYS_POFF_POS;
}

__STATIC_INLINE void pwrctrl_btcore_pwrsys_poff_setb(void)
{
    CS_PWRCTRL->BTCORE |=  PC_BTCORE_PWRSYS_POFF_BIT;
}
...
{
    return (CS_PWRCTRL->BTCORE & PC_BTCORE_AWAKE_SOFT_REQ_BIT) >> PC_BTCORE_AWAKE_SOFT_REQ_POS;
}

__STATIC_INLINE void pwrctrl_btcore_awake_soft_req_setb(void)
{
    CS_PWRCTRL->BTCORE |=  PC_BTCORE_AWAKE_SOFT_REQ_BIT;
}

__STATIC_INLINE uint8_t pwrctrl_btcore_awake_req_vld_clr_getb(void)
{
    return (CS_PWRCTRL->BTCORE & PC_BTCORE_AWAKE_REQVLDCLR_BIT) >> PC_BTCORE_AWAKE_REQVLDCLR_POS;
}

__STATIC_INLINE void pwrctrl_btcore_awake_req_vld_clr_setb(void)
{
    CS_PWRCTRL->BTCORE |=  PC_BTCORE_AWAKE_REQVLDCLR_BIT;
}

__STATIC_INLINE uint8_t pwrctrl_btcore_awake_soft_req_to_bt_getb(void)
{
    return (CS_PWRCTRL->BTCORE & PC_BTCORE_AWAKE_SOFTREQBT_BIT) >> PC_BTCORE_AWAKE_SOFTREQBT_POS;
}

__STATIC_INLINE void pwrctrl_btcore_awake_soft_req_to_bt_setb(void)
{
    CS_PWRCTRL->BTCORE |=  PC_BTCORE_AWAKE_SOFTREQBT_BIT;
}
...
{
    return CS_PWRCTRL->WIFICORE;
}

__STATIC_INLINE void pwrctrl_wificore_set(uint32_t reg_val)
{
    CS_PWRCTRL->WIFICORE = reg_val;
}

__STATIC_INLINE uint16_t pwrctrl_wificore_awake_src_getf(void)
{
    return ((CS_PWRCTRL->WIFICORE & PC_WIFICORE_AWAKE_SRC_MASK) >> PC_WIFICORE_AWAKE_SRC_LSB);
}

__STATIC_INLINE void pwrctrl_wificore_awake_src_setf(uint16_t awake_src)
{
    uint32_t local_val = CS_PWRCTRL->WIFICORE & ~PC_WIFICORE_AWAKE_SRC_MASK;
    CS_PWRCTRL->WIFICORE = local_val | ((awake_src << PC_WIFICORE_AWAKE_SRC_LSB) & PC_WIFICORE_AWAKE_SRC_MASK);
}

__STATIC_INLINE uint16_t pwrctrl_wificore_sleep_src_getf(void)
{
    return ((CS_PWRCTRL->WIFICORE & PC_WIFICORE_SLEEP_SRC_MASK) >> PC_WIFICORE_SLEEP_SRC_LSB);
}

__STATIC_INLINE void pwrctrl_wificore_sleep_src_setf(uint16_t awake_src)
{
    uint32_t local_val = CS_PWRCTRL->WIFICORE & ~PC_WIFICORE_SLEEP_SRC_MASK;
    CS_PWRCTRL->WIFICORE = local_val | ((awake_src << PC_WIFICORE_SLEEP_SRC_LSB) & PC_WIFICORE_SLEEP_SRC_MASK);
}

__STATIC_INLINE uint8_t pwrctrl_wificore_sleep_src_wifi_getb(void)
{
    return (CS_PWRCTRL->WIFICORE & PC_WIFICORE_SLEEP_SRC_WIFI_BIT) >> PC_WIFICORE_SLEEP_SRC_WIFI_POS;
}

__STATIC_INLINE void pwrctrl_wificore_sleep_src_wifi_setb(void)
{
    CS_PWRCTRL->WIFICORE |=  PC_WIFICORE_SLEEP_SRC_WIFI_BIT;
}
...
{
    return (CS_PWRCTRL->WIFICORE & PC_WIFICORE_SLEEP_SRC_BT_BIT) >> PC_WIFICORE_SLEEP_SRC_BT_POS;
}

__STATIC_INLINE void pwrctrl_wificore_sleep_src_bt_setb(void)
{
    CS_PWRCTRL->WIFICORE |=  PC_WIFICORE_SLEEP_SRC_BT_BIT;
}
...
{
    return (CS_PWRCTRL->WIFICORE & PC_WIFICORE_SLEEP_SOFT_REQ_BIT) >> PC_WIFICORE_SLEEP_SOFT_REQ_POS;
}

__STATIC_INLINE void pwrctrl_wificore_sleep_soft_req_setb(void)
{
    CS_PWRCTRL->WIFICORE |=  PC_WIFICORE_SLEEP_SOFT_REQ_BIT;
}

__STATIC_INLINE uint8_t pwrctrl_wificore_sleep_req_vld_clr_getb(void)
{
    return (CS_PWRCTRL->WIFICORE & PC_WIFICORE_SLEEP_REQVLDCLR_BIT) >> PC_WIFICORE_SLEEP_REQVLDCLR_POS;
}

__STATIC_INLINE void pwrctrl_wificore_sleep_req_vld_clr_setb(void)
{
    CS_PWRCTRL->WIFICORE |=  PC_WIFICORE_SLEEP_REQVLDCLR_BIT;
}

__STATIC_INLINE uint8_t pwrctrl_wificore_hwen_pon_getb(void)
{
    return (CS_PWRCTRL->WIFICORE & PC_WIFICORE_HWEN_PON_BIT) >> PC_WIFICORE_HWEN_PON_POS;
}

__STATIC_INLINE void pwrctrl_wificore_hwen_pon_setb(void)
{
    CS_PWRCTRL->WIFICORE |=  PC_WIFICORE_HWEN_PON_BIT;
}
...
{
    return (CS_PWRCTRL->WIFICORE & PC_WIFICORE_HWEN_POFF_BIT) >> PC_WIFICORE_HWEN_POFF_POS;
}

__STATIC_INLINE void pwrctrl_wificore_hwen_poff_setb(void)
{
    CS_PWRCTRL->WIFICORE |=  PC_WIFICORE_HWEN_POFF_BIT;
}
...
{
    return (CS_PWRCTRL->WIFICORE & PC_WIFICORE_PON_BIT) >> PC_WIFICORE_PON_POS;
}

__STATIC_INLINE void pwrctrl_wificore_pon_setb(void)
{
    CS_PWRCTRL->WIFICORE |=  PC_WIFICORE_PON_BIT;
}
...
{
    return (CS_PWRCTRL->WIFICORE & PC_WIFICORE_POFF_BIT) >> PC_WIFICORE_POFF_POS;
}

__STATIC_INLINE void pwrctrl_wificore_poff_setb(void)
{
    CS_PWRCTRL->WIFICORE |=  PC_WIFICORE_POFF_BIT;
}
...
{
    return (CS_PWRCTRL->WIFICORE & PC_WIFICORE_PWRSYS_TMR_POFF_BIT) >> PC_WIFICORE_PWRSYS_TMR_POFF_POS;
}

__STATIC_INLINE void pwrctrl_wificore_pwrsys_timer_poff_setb(void)
{
    CS_PWRCTRL->WIFICORE |=  PC_WIFICORE_PWRSYS_TMR_POFF_BIT;
}
...
{
    return (CS_PWRCTRL->WIFICORE & PC_WIFICORE_PWRSYS_PON_BIT) >> PC_WIFICORE_PWRSYS_PON_POS;
}

__STATIC_INLINE void pwrctrl_wificore_pwrsys_pon_setb(void)
{
    CS_PWRCTRL->WIFICORE |=  PC_WIFICORE_PWRSYS_PON_BIT;
}
...
{
    return (CS_PWRCTRL->WIFICORE & PC_WIFICORE_PWRSYS_POFF_BIT) >> PC_WIFICORE_PWRSYS_POFF_POS;
}

__STATIC_INLINE void pwrctrl_wificore_pwrsys_poff_setb(void)
{
    CS_PWRCTRL->WIFICORE |=  PC_WIFICORE_PWRSYS_POFF_BIT;
}
...
{
    return (CS_PWRCTRL->WIFICORE & PC_WIFICORE_AWAKE_SOFT_REQ_BIT) >> PC_WIFICORE_AWAKE_SOFT_REQ_POS;
}

__STATIC_INLINE void pwrctrl_wificore_awake_soft_req_setb(void)
{
    CS_PWRCTRL->WIFICORE |=  PC_WIFICORE_AWAKE_SOFT_REQ_BIT;
}

__STATIC_INLINE uint8_t pwrctrl_wificore_awake_req_vld_clr_getb(void)
{
    return (CS_PWRCTRL->WIFICORE & PC_WIFICORE_AWAKE_REQVLDCLR_BIT) >> PC_WIFICORE_AWAKE_REQVLDCLR_POS;
}

__STATIC_INLINE void pwrctrl_wificore_awake_req_vld_clr_setb(void)
{
    CS_PWRCTRL->WIFICORE |=  PC_WIFICORE_AWAKE_REQVLDCLR_BIT;
}

__STATIC_INLINE uint8_t pwrctrl_wificore_awake_soft_req_to_wifi_getb(void)
{
    return (CS_PWRCTRL->WIFICORE & PC_WIFICORE_AWAKE_SOFTREQWF_BIT) >> PC_WIFICORE_AWAKE_SOFTREQWF_POS;
}

__STATIC_INLINE void pwrctrl_wificore_awake_soft_req_to_wifi_setb(void)
{
    CS_PWRCTRL->WIFICORE |=  PC_WIFICORE_AWAKE_SOFTREQWF_BIT;
}
...
{
    return (CS_PWRCTRL->PWRSYS & PC_PWRSYS_CHIP_SLP_HW_EN_BIT) >> PC_PWRSYS_CHIP_SLP_HW_EN_POS;
}

__STATIC_INLINE void pwrctrl_pwrsys_chip_slp_hw_en_setb(void)
{
    CS_PWRCTRL->PWRSYS |=  PC_PWRSYS_CHIP_SLP_HW_EN_BIT;
}
...
{
    return ((CS_PWRCTRL->CTRLDLY[0] & PC_CTRLDLY1_PRE_DELAY_MASK) >> PC_CTRLDLY1_PRE_DELAY_LSB);
}

__STATIC_INLINE void pwrctrl_ctrldly1_pre_delay_setf(uint16_t delay)
{
    uint32_t local_val = CS_PWRCTRL->CTRLDLY[0] & ~PC_CTRLDLY1_PRE_DELAY_MASK;
    CS_PWRCTRL->CTRLDLY[0] = local_val | ((delay << PC_CTRLDLY1_PRE_DELAY_LSB) & PC_CTRLDLY1_PRE_DELAY_MASK);
}

__STATIC_INLINE uint16_t pwrctrl_ctrldly1_delay_getf(void)
{
    return ((CS_PWRCTRL->CTRLDLY[0] & PC_CTRLDLY1_DELAY_MASK) >> PC_CTRLDLY1_DELAY_LSB);
}

__STATIC_INLINE void pwrctrl_ctrldly1_delay_setf(uint16_t delay)
{
    uint32_t local_val = CS_PWRCTRL->CTRLDLY[0] & ~PC_CTRLDLY1_DELAY_MASK;
    CS_PWRCTRL->CTRLDLY[0] = local_val | ((delay << PC_CTRLDLY1_DELAY_LSB) & PC_CTRLDLY1_DELAY_MASK);
}
...
{
    return ((CS_PWRCTRL->CTRLDLY[1] & PC_CTRLDLY2_STATE_DELAY_MASK) >> PC_CTRLDLY2_STATE_DELAY_LSB);
}

__STATIC_INLINE void pwrctrl_ctrldly2_state_delay_setf(uint8_t delay)
{
    uint32_t local_val = CS_PWRCTRL->CTRLDLY[1] & ~PC_CTRLDLY2_STATE_DELAY_MASK;
    CS_PWRCTRL->CTRLDLY[1] = local_val | ((delay << PC_CTRLDLY2_STATE_DELAY_LSB) & PC_CTRLDLY2_STATE_DELAY_MASK);
}

__STATIC_INLINE uint8_t pwrctrl_ctrldly2_xtal_close_delay_getf(void)
{
    return ((CS_PWRCTRL->CTRLDLY[1] & PC_CTRLDLY2_XTAL_CLOSE_DELAY_MASK) >> PC_CTRLDLY2_XTAL_CLOSE_DELAY_LSB);
}

__STATIC_INLINE void pwrctrl_ctrldly2_xtal_close_delay_setf(uint8_t delay)
{
    uint32_t local_val = CS_PWRCTRL->CTRLDLY[1] & ~PC_CTRLDLY2_XTAL_CLOSE_DELAY_MASK;
    CS_PWRCTRL->CTRLDLY[1] = local_val | ((delay << PC_CTRLDLY2_XTAL_CLOSE_DELAY_LSB) & PC_CTRLDLY2_XTAL_CLOSE_DELAY_MASK);
}

__STATIC_INLINE uint8_t pwrctrl_ctrldly2_xtal_open_delay_getf(void)
{
    return ((CS_PWRCTRL->CTRLDLY[1] & PC_CTRLDLY2_XTAL_OPEN_DELAY_MASK) >> PC_CTRLDLY2_XTAL_OPEN_DELAY_LSB);
}

__STATIC_INLINE void pwrctrl_ctrldly2_xtal_open_delay_setf(uint8_t delay)
{
    uint32_t local_val = CS_PWRCTRL->CTRLDLY[1] & ~PC_CTRLDLY2_XTAL_OPEN_DELAY_MASK;
    CS_PWRCTRL->CTRLDLY[1] = local_val | ((delay << PC_CTRLDLY2_XTAL_OPEN_DELAY_LSB) & PC_CTRLDLY2_XTAL_OPEN_DELAY_MASK);
}

__STATIC_INLINE uint8_t pwrctrl_ctrldly2_pupd_xtal_delay_getf(void)
{
    return ((CS_PWRCTRL->CTRLDLY[1] & PC_CTRLDLY2_PUPD_XTAL_DELAY_MASK) >> PC_CTRLDLY2_PUPD_XTAL_DELAY_LSB);
}

__STATIC_INLINE void pwrctrl_ctrldly2_pupd_xtal_delay_setf(uint8_t delay)
{
    uint32_t local_val = CS_PWRCTRL->CTRLDLY[1] & ~PC_CTRLDLY2_PUPD_XTAL_DELAY_MASK;
    CS_PWRCTRL->CTRLDLY[1] = local_val | ((delay << PC_CTRLDLY2_PUPD_XTAL_DELAY_LSB) & PC_CTRLDLY2_PUPD_XTAL_DELAY_MASK);
}
...
{
    return ((CS_PWRCTRL->SYSDLY[0] & PC_SYSDLY1_DP_OPEN_DELAY_MASK) >> PC_SYSDLY1_DP_OPEN_DELAY_LSB);
}

__STATIC_INLINE void pwrctrl_sysdly1_dp_open_delay_setf(uint8_t delay)
{
    uint32_t local_val = CS_PWRCTRL->SYSDLY[0] & ~PC_SYSDLY1_DP_OPEN_DELAY_MASK;
    CS_PWRCTRL->SYSDLY[0] = local_val | ((delay << PC_SYSDLY1_DP_OPEN_DELAY_LSB) & PC_SYSDLY1_DP_OPEN_DELAY_MASK);
}

__STATIC_INLINE uint8_t pwrctrl_sysdly1_dp_close_delay_getf(void)
{
    return ((CS_PWRCTRL->SYSDLY[0] & PC_SYSDLY1_DP_CLOSE_DELAY_MASK) >> PC_SYSDLY1_DP_CLOSE_DELAY_LSB);
}

__STATIC_INLINE void pwrctrl_sysdly1_dp_close_delay_setf(uint8_t delay)
{
    uint32_t local_val = CS_PWRCTRL->SYSDLY[0] & ~PC_SYSDLY1_DP_CLOSE_DELAY_MASK;
    CS_PWRCTRL->SYSDLY[0] = local_val | ((delay << PC_SYSDLY1_DP_CLOSE_DELAY_LSB) & PC_SYSDLY1_DP_CLOSE_DELAY_MASK);
}

__STATIC_INLINE uint8_t pwrctrl_sysdly1_cg_open_delay_getf(void)
{
    return ((CS_PWRCTRL->SYSDLY[0] & PC_SYSDLY1_CG_OPEN_DELAY_MASK) >> PC_SYSDLY1_CG_OPEN_DELAY_LSB);
}
...
__STATIC_INLINE void pwrctrl_sysdly1_cg_open_delay_setf(uint8_t delay)
{
    ...
    CS_PWRCTRL->SYSDLY[0] = local_val | ((delay << PC_SYSDLY1_CG_OPEN_DELAY_LSB) & PC_SYSDLY1_CG_OPEN_DELAY_MASK);
}

__STATIC_INLINE uint8_t pwrctrl_sysdly1_cg_close_delay_getf(void)
{
    return ((CS_PWRCTRL->SYSDLY[0] & PC_SYSDLY1_CG_CLOSE_DELAY_MASK) >> PC_SYSDLY1_CG_CLOSE_DELAY_LSB);
}

__STATIC_INLINE void pwrctrl_sysdly1_cg_close_delay_setf(uint8_t delay)
{
    uint32_t local_val = CS_PWRCTRL->SYSDLY[0] & ~PC_SYSDLY1_CG_CLOSE_DELAY_MASK;
    CS_PWRCTRL->SYSDLY[0] = local_val | ((delay << PC_SYSDLY1_CG_CLOSE_DELAY_LSB) & PC_SYSDLY1_CG_CLOSE_DELAY_MASK);
}
...
{
    return ((CS_PWRCTRL->SYSDLY[1] & PC_SYSDLY2_PWR_OPEN_DELAY_MASK) >> PC_SYSDLY2_PWR_OPEN_DELAY_LSB);
}

__STATIC_INLINE void pwrctrl_sysdly2_pwr_open_delay_setf(uint8_t delay)
{
    uint32_t local_val = CS_PWRCTRL->SYSDLY[1] & ~PC_SYSDLY2_PWR_OPEN_DELAY_MASK;
    CS_PWRCTRL->SYSDLY[1] = local_val | ((delay << PC_SYSDLY2_PWR_OPEN_DELAY_LSB) & PC_SYSDLY2_PWR_OPEN_DELAY_MASK);
}

__STATIC_INLINE uint8_t pwrctrl_sysdly2_pwr_close_delay_getf(void)
{
    return ((CS_PWRCTRL->SYSDLY[1] & PC_SYSDLY2_PWR_CLOSE_DELAY_MASK) >> PC_SYSDLY2_PWR_CLOSE_DELAY_LSB);
}

__STATIC_INLINE void pwrctrl_sysdly2_pwr_close_delay_setf(uint8_t delay)
{
    uint32_t local_val = CS_PWRCTRL->SYSDLY[1] & ~PC_SYSDLY2_PWR_CLOSE_DELAY_MASK;
    CS_PWRCTRL->SYSDLY[1] = local_val | ((delay << PC_SYSDLY2_PWR_CLOSE_DELAY_LSB) & PC_SYSDLY2_PWR_CLOSE_DELAY_MASK);
}

__STATIC_INLINE uint8_t pwrctrl_sysdly2_pll_open_delay_getf(void)
{
    return ((CS_PWRCTRL->SYSDLY[1] & PC_SYSDLY2_PLL_OPEN_DELAY_MASK) >> PC_SYSDLY2_PLL_OPEN_DELAY_LSB);
}

__STATIC_INLINE void pwrctrl_sysdly2_pll_open_delay_setf(uint8_t delay)
{
    uint32_t local_val = CS_PWRCTRL->SYSDLY[1] & ~PC_SYSDLY2_PLL_OPEN_DELAY_MASK;
    CS_PWRCTRL->SYSDLY[1] = local_val | ((delay << PC_SYSDLY2_PLL_OPEN_DELAY_LSB) & PC_SYSDLY2_PLL_OPEN_DELAY_MASK);
}

__STATIC_INLINE uint8_t pwrctrl_sysdly2_pll_close_delay_getf(void)
{
    return ((CS_PWRCTRL->SYSDLY[1] & PC_SYSDLY2_PLL_CLOSE_DELAY_MASK) >> PC_SYSDLY2_PLL_CLOSE_DELAY_LSB);
}

__STATIC_INLINE void pwrctrl_sysdly2_pll_close_delay_setf(uint8_t delay)
{
    uint32_t local_val = CS_PWRCTRL->SYSDLY[1] & ~PC_SYSDLY2_PLL_CLOSE_DELAY_MASK;
    CS_PWRCTRL->SYSDLY[1] = local_val | ((delay << PC_SYSDLY2_PLL_CLOSE_DELAY_LSB) & PC_SYSDLY2_PLL_CLOSE_DELAY_MASK);
}
...
{
    return (CS_PWRCTRL->STATE[0] & PC_STATE1_PONSTAB_WIFICORE_BIT) >> PC_STATE1_PONSTAB_WIFICORE_POS;
}

__STATIC_INLINE uint8_t pwrctrl_state1_pon_stable_btcore_getb(void)
{
    return (CS_PWRCTRL->STATE[0] & PC_STATE1_PONSTAB_BTCORE_BIT) >> PC_STATE1_PONSTAB_BTCORE_POS;
}

__STATIC_INLINE uint8_t pwrctrl_state1_pon_stable_cpusys_getb(void)
{
    return (CS_PWRCTRL->STATE[0] & PC_STATE1_PONSTAB_CPUSYS_BIT) >> PC_STATE1_PONSTAB_CPUSYS_POS;
}

__STATIC_INLINE uint8_t pwrctrl_state1_poff_stable_wificore_getb(void)
{
    return (CS_PWRCTRL->STATE[0] & PC_STATE1_POFFSTAB_WIFICORE_BIT) >> PC_STATE1_POFFSTAB_WIFICORE_POS;
}

__STATIC_INLINE uint8_t pwrctrl_state1_poff_stable_btcore_getb(void)
{
    return (CS_PWRCTRL->STATE[0] & PC_STATE1_POFFSTAB_BTCORE_BIT) >> PC_STATE1_POFFSTAB_BTCORE_POS;
}

__STATIC_INLINE uint8_t pwrctrl_state1_poff_stable_cpusys_getb(void)
{
    return (CS_PWRCTRL->STATE[0] & PC_STATE1_POFFSTAB_CPUSYS_BIT) >> PC_STATE1_POFFSTAB_CPUSYS_POS;
}

__STATIC_INLINE uint8_t pwrctrl_state1_state_wificore_getf(void)
{
    return ((CS_PWRCTRL->STATE[0] & PC_STATE1_STATE_WIFICORE_MASK) >> PC_STATE1_STATE_WIFICORE_LSB);
}

__STATIC_INLINE uint8_t pwrctrl_state1_state_btcore_getf(void)
{
    return ((CS_PWRCTRL->STATE[0] & PC_STATE1_STATE_BTCORE_MASK) >> PC_STATE1_STATE_BTCORE_LSB);
}

__STATIC_INLINE uint8_t pwrctrl_state1_state_cpusys_getf(void)
{
    return ((CS_PWRCTRL->STATE[0] & PC_STATE1_STATE_CPUSYS_MASK) >> PC_STATE1_STATE_CPUSYS_LSB);
}

__STATIC_INLINE uint8_t pwrctrl_state1_curstate_wificore_getf(void)
{
    return ((CS_PWRCTRL->STATE[0] & PC_STATE1_CURSTATE_WIFICORE_MASK) >> PC_STATE1_CURSTATE_WIFICORE_LSB);
}

__STATIC_INLINE uint8_t pwrctrl_state1_curstate_btcore_getf(void)
{
    return ((CS_PWRCTRL->STATE[0] & PC_STATE1_CURSTATE_BTCORE_MASK) >> PC_STATE1_CURSTATE_BTCORE_LSB);
}

__STATIC_INLINE uint8_t pwrctrl_state1_curstate_cpusys_getf(void)
{
    return ((CS_PWRCTRL->STATE[0] & PC_STATE1_CURSTATE_CPUSYS_MASK) >> PC_STATE1_CURSTATE_CPUSYS_LSB);
}

__STATIC_INLINE uint8_t pwrctrl_state1_curstate_pwrsys_getf(void)
{
    return ((CS_PWRCTRL->STATE[0] & PC_STATE1_CURSTATE_PWRSYS_MASK) >> PC_STATE1_CURSTATE_PWRSYS_LSB);
}

__STATIC_INLINE uint8_t pwrctrl_state1_curstate_vcoresys_getf(void)
{
    return ((CS_PWRCTRL->STATE[0] & PC_STATE1_CURSTATE_VCORESYS_MASK) >> PC_STATE1_CURSTATE_VCORESYS_LSB);
}
...
{
    return (CS_PWRCTRL->STATE[1] & PC_STATE2_PONSTAB_VCORESYS_BIT) >> PC_STATE2_PONSTAB_VCORESYS_POS;
}

__STATIC_INLINE uint8_t pwrctrl_state2_pon_stable_aonram1_getb(void)
{
    return (CS_PWRCTRL->STATE[1] & PC_STATE2_PONSTAB_AONRAM1_BIT) >> PC_STATE2_PONSTAB_AONRAM1_POS;
}

__STATIC_INLINE uint8_t pwrctrl_state2_pon_stable_aonram2_getb(void)
{
    return (CS_PWRCTRL->STATE[1] & PC_STATE2_PONSTAB_AONRAM2_BIT) >> PC_STATE2_PONSTAB_AONRAM2_POS;
}

__STATIC_INLINE uint8_t pwrctrl_state2_pon_stable_mmsys_getb(void)
{
    return (CS_PWRCTRL->STATE[1] & PC_STATE2_PONSTAB_MMSYS_BIT) >> PC_STATE2_PONSTAB_MMSYS_POS;
}
...
{
    return (CS_PWRCTRL->STATE[1] & PC_STATE2_POFFSTAB_AONRAM1_BIT) >> PC_STATE2_POFFSTAB_AONRAM1_POS;
}

__STATIC_INLINE uint8_t pwrctrl_state2_poff_stable_aonram2_getb(void)
{
    return (CS_PWRCTRL->STATE[1] & PC_STATE2_POFFSTAB_AONRAM2_BIT) >> PC_STATE2_POFFSTAB_AONRAM2_POS;
}

__STATIC_INLINE uint8_t pwrctrl_state2_poff_stable_mmsys_getb(void)
{
    return (CS_PWRCTRL->STATE[1] & PC_STATE2_POFFSTAB_MMSYS_BIT) >> PC_STATE2_POFFSTAB_MMSYS_POS;
}

__STATIC_INLINE uint8_t pwrctrl_state2_state_aonram1_getf(void)
{
    return ((CS_PWRCTRL->STATE[1] & PC_STATE2_STATE_AONRAM1_MASK) >> PC_STATE2_STATE_AONRAM1_LSB);
}

__STATIC_INLINE uint8_t pwrctrl_state2_state_aonram2_getf(void)
{
    return ((CS_PWRCTRL->STATE[1] & PC_STATE2_STATE_AONRAM2_MASK) >> PC_STATE2_STATE_AONRAM2_LSB);
}

__STATIC_INLINE uint8_t pwrctrl_state2_state_mmsys_getf(void)
{
    return ((CS_PWRCTRL->STATE[1] & PC_STATE2_STATE_MMSYS_MASK) >> PC_STATE2_STATE_MMSYS_LSB);
}

__STATIC_INLINE uint8_t pwrctrl_state2_state_vcoresys_getf(void)
{
    return ((CS_PWRCTRL->STATE[1] & PC_STATE2_STATE_VCORESYS_MASK) >> PC_STATE2_STATE_VCORESYS_LSB);
}
...
{
    return ((CS_PWRCTRL->SOFTMD1 & PC_SOFTMD1_CPUSYS_PWRCTRL_SOFT_MASK) >> PC_SOFTMD1_CPUSYS_PWRCTRL_SOFT_LSB);
}

__STATIC_INLINE void pwrctrl_softmd1_cpusys_pwrctrl_soft_setf(uint8_t pwrctrl_soft)
{
    uint32_t local_val = CS_PWRCTRL->SOFTMD1 & ~PC_SOFTMD1_CPUSYS_PWRCTRL_SOFT_MASK;
    CS_PWRCTRL->SOFTMD1 = local_val | ((pwrctrl_soft << PC_SOFTMD1_CPUSYS_PWRCTRL_SOFT_LSB) & PC_SOFTMD1_CPUSYS_PWRCTRL_SOFT_MASK);
}

__STATIC_INLINE uint8_t pwrctrl_softmd1_btcore_pwrctrl_soft_getf(void)
{
    return ((CS_PWRCTRL->SOFTMD1 & PC_SOFTMD1_BTCORE_PWRCTRL_SOFT_MASK) >> PC_SOFTMD1_BTCORE_PWRCTRL_SOFT_LSB);
}

__STATIC_INLINE void pwrctrl_softmd1_btcore_pwrctrl_soft_setf(uint8_t pwrctrl_soft)
{
    uint32_t local_val = CS_PWRCTRL->SOFTMD1 & ~PC_SOFTMD1_BTCORE_PWRCTRL_SOFT_MASK;
    CS_PWRCTRL->SOFTMD1 = local_val | ((pwrctrl_soft << PC_SOFTMD1_BTCORE_PWRCTRL_SOFT_LSB) & PC_SOFTMD1_BTCORE_PWRCTRL_SOFT_MASK);
}

__STATIC_INLINE uint8_t pwrctrl_softmd1_wificore_pwrctrl_soft_getf(void)
{
    return ((CS_PWRCTRL->SOFTMD1 & PC_SOFTMD1_WIFICORE_PWRCTRL_SOFT_MASK) >> PC_SOFTMD1_WIFICORE_PWRCTRL_SOFT_LSB);
}

__STATIC_INLINE void pwrctrl_softmd1_wificore_pwrctrl_soft_setf(uint8_t pwrctrl_soft)
{
    uint32_t local_val = CS_PWRCTRL->SOFTMD1 & ~PC_SOFTMD1_WIFICORE_PWRCTRL_SOFT_MASK;
    CS_PWRCTRL->SOFTMD1 = local_val | ((pwrctrl_soft << PC_SOFTMD1_WIFICORE_PWRCTRL_SOFT_LSB) & PC_SOFTMD1_WIFICORE_PWRCTRL_SOFT_MASK);
}

__STATIC_INLINE uint8_t pwrctrl_softmd1_aonram1_pwrctrl_soft_getf(void)
{
    return ((CS_PWRCTRL->SOFTMD1 & PC_SOFTMD1_AONRAM1_PWRCTRL_SOFT_MASK) >> PC_SOFTMD1_AONRAM1_PWRCTRL_SOFT_LSB);
}

__STATIC_INLINE void pwrctrl_softmd1_aonram1_pwrctrl_soft_setf(uint8_t pwrctrl_soft)
{
    uint32_t local_val = CS_PWRCTRL->SOFTMD1 & ~PC_SOFTMD1_AONRAM1_PWRCTRL_SOFT_MASK;
    CS_PWRCTRL->SOFTMD1 = local_val | ((pwrctrl_soft << PC_SOFTMD1_AONRAM1_PWRCTRL_SOFT_LSB) & PC_SOFTMD1_AONRAM1_PWRCTRL_SOFT_MASK);
}

__STATIC_INLINE uint8_t pwrctrl_softmd1_aonram2_pwrctrl_soft_getf(void)
{
    return ((CS_PWRCTRL->SOFTMD1 & PC_SOFTMD1_AONRAM2_PWRCTRL_SOFT_MASK) >> PC_SOFTMD1_AONRAM2_PWRCTRL_SOFT_LSB);
}

__STATIC_INLINE void pwrctrl_softmd1_aonram2_pwrctrl_soft_setf(uint8_t pwrctrl_soft)
{
    uint32_t local_val = CS_PWRCTRL->SOFTMD1 & ~PC_SOFTMD1_AONRAM2_PWRCTRL_SOFT_MASK;
    CS_PWRCTRL->SOFTMD1 = local_val | ((pwrctrl_soft << PC_SOFTMD1_AONRAM2_PWRCTRL_SOFT_LSB) & PC_SOFTMD1_AONRAM2_PWRCTRL_SOFT_MASK);
}
...
{
    return (CS_PWRCTRL->MMSYS & PC_MMSYS_PON_BIT) >> PC_MMSYS_PON_POS;
}

__STATIC_INLINE void pwrctrl_mmsys_pon_setb(void)
{
    CS_PWRCTRL->MMSYS |=  PC_MMSYS_PON_BIT;
}
...
{
    return (CS_PWRCTRL->MMSYS & PC_MMSYS_POFF_BIT) >> PC_MMSYS_POFF_POS;
}

__STATIC_INLINE void pwrctrl_mmsys_poff_setb(void)
{
    CS_PWRCTRL->MMSYS |=  PC_MMSYS_POFF_BIT;
}
...
{
    uint32_t local_val = CS_PWRCTRL->SOFTMD2 & ~PC_SOFTMD2_MMSYS_PWRCTRL_SOFT_MASK;
    CS_PWRCTRL->SOFTMD2 = local_val | ((pwrctrl_soft << PC_SOFTMD2_MMSYS_PWRCTRL_SOFT_LSB) & PC_SOFTMD2_MMSYS_PWRCTRL_SOFT_MASK);
}

__STATIC_INLINE uint8_t pwrctrl_softmd2_vcoresys_pwrctrl_soft_getf(void)
{
    return ((CS_PWRCTRL->SOFTMD2 & PC_SOFTMD2_VCORESYS_PWRCTRL_SOFT_MASK) >> PC_SOFTMD2_VCORESYS_PWRCTRL_SOFT_LSB);
}

__STATIC_INLINE void pwrctrl_softmd2_vcoresys_pwrctrl_soft_setf(uint8_t pwrctrl_soft)
{
    uint32_t local_val = CS_PWRCTRL->SOFTMD2 & ~PC_SOFTMD2_VCORESYS_PWRCTRL_SOFT_MASK;
    CS_PWRCTRL->SOFTMD2 = local_val | ((pwrctrl_soft << PC_SOFTMD2_VCORESYS_PWRCTRL_SOFT_LSB) & PC_SOFTMD2_VCORESYS_PWRCTRL_SOFT_MASK);
}

__STATIC_INLINE uint8_t pwrctrl_softmd2_slp_mode_sel_aonram1_getb(void)
{
    return (CS_PWRCTRL->SOFTMD2 & PC_SOFTMD2_SLP_MODE_SEL_AONRAM1_BIT) >> PC_SOFTMD2_SLP_MODE_SEL_AONRAM1_POS;
}

__STATIC_INLINE void pwrctrl_softmd2_slp_mode_sel_aonram1_setb(void)
{
    CS_PWRCTRL->SOFTMD2 |=  PC_SOFTMD2_SLP_MODE_SEL_AONRAM1_BIT;
}
...
{
    return (CS_PWRCTRL->SOFTMD2 & PC_SOFTMD2_SLP_MODE_SEL_AONRAM2_BIT) >> PC_SOFTMD2_SLP_MODE_SEL_AONRAM2_POS;
}

__STATIC_INLINE void pwrctrl_softmd2_slp_mode_sel_aonram2_setb(void)
{
    CS_PWRCTRL->SOFTMD2 |=  PC_SOFTMD2_SLP_MODE_SEL_AONRAM2_BIT;
}
...
{
    return (CS_PWRCTRL->SOFTMD2 & PC_SOFTMD2_SLP_MODE_SEL_BTCORE_BIT) >> PC_SOFTMD2_SLP_MODE_SEL_BTCORE_POS;
}

__STATIC_INLINE void pwrctrl_softmd2_slp_mode_sel_btcore_setb(void)
{
    CS_PWRCTRL->SOFTMD2 |=  PC_SOFTMD2_SLP_MODE_SEL_BTCORE_BIT;
}
...
{
    return (CS_PWRCTRL->SOFTMD2 & PC_SOFTMD2_SLP_MODE_SEL_CPUSYS_BIT) >> PC_SOFTMD2_SLP_MODE_SEL_CPUSYS_POS;
}

__STATIC_INLINE void pwrctrl_softmd2_slp_mode_sel_cpusys_setb(void)
{
    CS_PWRCTRL->SOFTMD2 |=  PC_SOFTMD2_SLP_MODE_SEL_CPUSYS_BIT;
}
...
{
    return (CS_PWRCTRL->SOFTMD2 & PC_SOFTMD2_SLP_MODE_SEL_MMSYS_BIT) >> PC_SOFTMD2_SLP_MODE_SEL_MMSYS_POS;
}

__STATIC_INLINE void pwrctrl_softmd2_slp_mode_sel_mmsys_setb(void)
{
    CS_PWRCTRL->SOFTMD2 |=  PC_SOFTMD2_SLP_MODE_SEL_MMSYS_BIT;
}
...
{
    return (CS_PWRCTRL->SOFTMD2 & PC_SOFTMD2_SLP_MODE_SEL_VCORESYS_BIT) >> PC_SOFTMD2_SLP_MODE_SEL_VCORESYS_POS;
}

__STATIC_INLINE void pwrctrl_softmd2_slp_mode_sel_vcoresys_setb(void)
{
    CS_PWRCTRL->SOFTMD2 |=  PC_SOFTMD2_SLP_MODE_SEL_VCORESYS_BIT;
}
...
{
    return (CS_PWRCTRL->SOFTMD2 & PC_SOFTMD2_SLP_MODE_SEL_WIFICORE_BIT) >> PC_SOFTMD2_SLP_MODE_SEL_WIFICORE_POS;
}

__STATIC_INLINE void pwrctrl_softmd2_slp_mode_sel_wificore_setb(void)
{
    CS_PWRCTRL->SOFTMD2 |=  PC_SOFTMD2_SLP_MODE_SEL_WIFICORE_BIT;
}
...
{
    return CS_PWRCTRL->VCORESYS;
}

__STATIC_INLINE void pwrctrl_vcoresys_set(uint32_t reg_val)
{
    CS_PWRCTRL->VCORESYS = reg_val;
}

__STATIC_INLINE uint16_t pwrctrl_vcoresys_awake_src_getf(void)
{
    return ((CS_PWRCTRL->VCORESYS & PC_VCORESYS_AWAKE_SRC_MASK) >> PC_VCORESYS_AWAKE_SRC_LSB);
}

__STATIC_INLINE void pwrctrl_vcoresys_awake_src_setf(uint16_t awake_src)
{
    uint32_t local_val = CS_PWRCTRL->VCORESYS & ~PC_VCORESYS_AWAKE_SRC_MASK;
    CS_PWRCTRL->VCORESYS = local_val | ((awake_src << PC_VCORESYS_AWAKE_SRC_LSB) & PC_VCORESYS_AWAKE_SRC_MASK);
}

__STATIC_INLINE uint16_t pwrctrl_vcoresys_sleep_src_getf(void)
{
    return ((CS_PWRCTRL->VCORESYS & PC_VCORESYS_SLEEP_SRC_MASK) >> PC_VCORESYS_SLEEP_SRC_LSB);
}

__STATIC_INLINE void pwrctrl_vcoresys_sleep_src_setf(uint16_t awake_src)
{
    uint32_t local_val = CS_PWRCTRL->VCORESYS & ~PC_VCORESYS_SLEEP_SRC_MASK;
    CS_PWRCTRL->VCORESYS = local_val | ((awake_src << PC_VCORESYS_SLEEP_SRC_LSB) & PC_VCORESYS_SLEEP_SRC_MASK);
}

__STATIC_INLINE uint8_t pwrctrl_vcoresys_sleep_src_wifi_getb(void)
{
    return (CS_PWRCTRL->VCORESYS & PC_VCORESYS_SLEEP_SRC_WIFI_BIT) >> PC_VCORESYS_SLEEP_SRC_WIFI_POS;
}

__STATIC_INLINE void pwrctrl_vcoresys_sleep_src_wifi_setb(void)
{
    CS_PWRCTRL->VCORESYS |=  PC_VCORESYS_SLEEP_SRC_WIFI_BIT;
}
...
{
    return (CS_PWRCTRL->VCORESYS & PC_VCORESYS_SLEEP_SRC_BT_BIT) >> PC_VCORESYS_SLEEP_SRC_BT_POS;
}

__STATIC_INLINE void pwrctrl_vcoresys_sleep_src_bt_setb(void)
{
    CS_PWRCTRL->VCORESYS |=  PC_VCORESYS_SLEEP_SRC_BT_BIT;
}
...
{
    return (CS_PWRCTRL->VCORESYS & PC_VCORESYS_SLEEP_SOFT_REQ_BIT) >> PC_VCORESYS_SLEEP_SOFT_REQ_POS;
}

__STATIC_INLINE void pwrctrl_vcoresys_sleep_soft_req_setb(void)
{
    CS_PWRCTRL->VCORESYS |=  PC_VCORESYS_SLEEP_SOFT_REQ_BIT;
}

__STATIC_INLINE uint8_t pwrctrl_vcoresys_sleep_req_vld_clr_getb(void)
{
    return (CS_PWRCTRL->VCORESYS & PC_VCORESYS_SLEEP_REQVLDCLR_BIT) >> PC_VCORESYS_SLEEP_REQVLDCLR_POS;
}

__STATIC_INLINE void pwrctrl_vcoresys_sleep_req_vld_clr_setb(void)
{
    CS_PWRCTRL->VCORESYS |=  PC_VCORESYS_SLEEP_REQVLDCLR_BIT;
}

__STATIC_INLINE uint8_t pwrctrl_vcoresys_hwen_pon_getb(void)
{
    return (CS_PWRCTRL->VCORESYS & PC_VCORESYS_HWEN_PON_BIT) >> PC_VCORESYS_HWEN_PON_POS;
}

__STATIC_INLINE void pwrctrl_vcoresys_hwen_pon_setb(void)
{
    CS_PWRCTRL->VCORESYS |=  PC_VCORESYS_HWEN_PON_BIT;
}
...
{
    return (CS_PWRCTRL->VCORESYS & PC_VCORESYS_HWEN_POFF_BIT) >> PC_VCORESYS_HWEN_POFF_POS;
}

__STATIC_INLINE void pwrctrl_vcoresys_hwen_poff_setb(void)
{
    CS_PWRCTRL->VCORESYS |=  PC_VCORESYS_HWEN_POFF_BIT;
}
...
{
    return (CS_PWRCTRL->VCORESYS & PC_VCORESYS_PON_BIT) >> PC_VCORESYS_PON_POS;
}

__STATIC_INLINE void pwrctrl_vcoresys_pon_setb(void)
{
    CS_PWRCTRL->VCORESYS |=  PC_VCORESYS_PON_BIT;
}
...
{
    return (CS_PWRCTRL->VCORESYS & PC_VCORESYS_POFF_BIT) >> PC_VCORESYS_POFF_POS;
}

__STATIC_INLINE void pwrctrl_vcoresys_poff_setb(void)
{
    CS_PWRCTRL->VCORESYS |=  PC_VCORESYS_POFF_BIT;
}
...
{
    return (CS_PWRCTRL->VCORESYS & PC_VCORESYS_PWRSYS_TMR_POFF_BIT) >> PC_VCORESYS_PWRSYS_TMR_POFF_POS;
}

__STATIC_INLINE void pwrctrl_vcoresys_pwrsys_timer_poff_setb(void)
{
    CS_PWRCTRL->VCORESYS |=  PC_VCORESYS_PWRSYS_TMR_POFF_BIT;
}
...
{
    return (CS_PWRCTRL->VCORESYS & PC_VCORESYS_PWRSYS_PON_BIT) >> PC_VCORESYS_PWRSYS_PON_POS;
}

__STATIC_INLINE void pwrctrl_vcoresys_pwrsys_pon_setb(void)
{
    CS_PWRCTRL->VCORESYS |=  PC_VCORESYS_PWRSYS_PON_BIT;
}
...
{
    return (CS_PWRCTRL->VCORESYS & PC_VCORESYS_PWRSYS_POFF_BIT) >> PC_VCORESYS_PWRSYS_POFF_POS;
}

__STATIC_INLINE void pwrctrl_vcoresys_pwrsys_poff_setb(void)
{
    CS_PWRCTRL->VCORESYS |=  PC_VCORESYS_PWRSYS_POFF_BIT;
}
...
{
    return (CS_PWRCTRL->VCORESYS & PC_VCORESYS_AWAKE_SOFT_REQ_BIT) >> PC_VCORESYS_AWAKE_SOFT_REQ_POS;
}

__STATIC_INLINE void pwrctrl_vcoresys_awake_soft_req_setb(void)
{
    CS_PWRCTRL->VCORESYS |=  PC_VCORESYS_AWAKE_SOFT_REQ_BIT;
}

__STATIC_INLINE uint8_t pwrctrl_vcoresys_awake_req_vld_clr_getb(void)
{
    return (CS_PWRCTRL->VCORESYS & PC_VCORESYS_AWAKE_REQVLDCLR_BIT) >> PC_VCORESYS_AWAKE_REQVLDCLR_POS;
}
...
{
    return ((CS_PWRCTRL->PWRMD & PC_PWRMD_CPUSYS_SW_RECORD_MASK) >> PC_PWRMD_CPUSYS_SW_RECORD_LSB);
}

__STATIC_INLINE void pwrctrl_pwrmd_cpusys_sw_record_setf(uint32_t mode)
{
    uint32_t local_val = CS_PWRCTRL->PWRMD & ~PC_PWRMD_CPUSYS_SW_RECORD_MASK;
    CS_PWRCTRL->PWRMD = local_val | ((mode << PC_PWRMD_CPUSYS_SW_RECORD_LSB) & PC_PWRMD_CPUSYS_SW_RECORD_MASK) | PC_PWRMD_UPDATE_BIT;
}

__STATIC_INLINE uint8_t pwrctrl_pwrmd_flash_clksel_fast_getb(void)
{
    return (CS_PWRCTRL->PWRMD & PC_PWRMD_FLASH_CLKSEL_FAST_BIT) >> PC_PWRMD_FLASH_CLKSEL_FAST_POS;
}

__STATIC_INLINE void pwrctrl_pwrmd_flash_clksel_fast_setb(void)
{
    CS_PWRCTRL->PWRMD |=  PC_PWRMD_FLASH_CLKSEL_FAST_BIT;
}
...
{
    return ((CS_PWRCTRL->PWRMD & (PC_PWRMD_FLASH_CLKDIV_MASK | PC_PWRMD_FLASH_SMPLDLY_MASK)) >> PC_PWRMD_FLASH_SMPLDLY_LSB);
}

__STATIC_INLINE void pwrctrl_pwrmd_flash_clkdiv_smpldly_setf(uint32_t div_dly)
{
    uint32_t local_val = CS_PWRCTRL->PWRMD & ~(PC_PWRMD_FLASH_CLKDIV_MASK | PC_PWRMD_FLASH_SMPLDLY_MASK);
    CS_PWRCTRL->PWRMD = local_val | ((div_dly << PC_PWRMD_FLASH_SMPLDLY_LSB) & (PC_PWRMD_FLASH_CLKDIV_MASK | PC_PWRMD_FLASH_SMPLDLY_MASK));
}
