 ...
 */
#ifndef _CS1000LITE_LED_PWM_H_
#define _CS1000LITE_LED_PWM_H_
...
// ============================================================================
// CS1000LITE_LED_PWM_T
// -----------------------------------------------------------------------------
///
// =============================================================================
#define REG_CS1000LITE_LED_PWM_BASE 0x50014000
...
} HWP_CS1000LITE_LED_PWM_T;

static HWP_CS1000LITE_LED_PWM_T * const cs1000liteLedPwm = ((HWP_CS1000LITE_LED_PWM_T *)REG_CS1000LITE_LED_PWM_BASE);


//tmr0_ld_value
#define CS1000LITE_LED_PWM_TMR_LD_VALUE(n) (((n)&0xFFFFFFFF)<<0)

//tmr0_cnt_value
#define CS1000LITE_LED_PWM_TMR_CNT_VALUE(n) (((n)&0xFFFFFFFF)<<0)

//tmr0_cfg
#define CS1000LITE_LED_PWM_TMR_MODE (1<<0)
#define CS1000LITE_LED_PWM_TMR_RUN (1<<1)

//tmr0_int_ctrl
#define CS1000LITE_LED_PWM_TMR_INT_EN (1<<0)
#define CS1000LITE_LED_PWM_TMR_INT_RAW (1<<1)
#define CS1000LITE_LED_PWM_TMR_INT_STATUS (1<<2)
#define CS1000LITE_LED_PWM_TMR_INT_CLR (1<<3)

//tmr0_cnt_read
#define CS1000LITE_LED_PWM_TMR_CNT_READ(n) (((n)&0xFFFFFFFF)<<0)
...
//tmr2_cnt_read
#define CS1000LITE_LED_PWM_TMR2_CNT_READ(n) (((n)&0xFFFFFFFF)<<0)

//pwm0_sta_val
#define CS1000LITE_LED_PWM_PWM_STA_VAL(n) (((n)&0xFFFFFFFF)<<0)

//pwm0_end_val
#define CS1000LITE_LED_PWM_PWM_END_VAL(n) (((n)&0xFFFFFFFF)<<0)

//pwm0_step_cfg0
#define CS1000LITE_LED_PWM_PWM_STEP_CYC(n) (((n)&0xFFFF)<<0)
#define CS1000LITE_LED_PWM_PWM_STEP_NUM(n) (((n)&0xFFFF)<<16)

//pwm0_step_cfg1
#define CS1000LITE_LED_PWM_PWM_STEP_VALUE(n) (((n)&0xFFFFFFFF)<<0)

//pwm0_cfg
#define CS1000LITE_LED_PWM_PWM_RUN (1<<0)
#define CS1000LITE_LED_PWM_PWM_INC_MODE (1<<1)
#define CS1000LITE_LED_PWM_PWM_DEFAULT_VAL (1<<2)
#define CS1000LITE_LED_PWM_PWM_TMR_SEL(n) (((n)&3)<<16)
#define CS1000LITE_LED_PWM_PWM_UPDATE (1<<31)

//pwm0_int_ctrl
#define CS1000LITE_LED_PWM_PWM_INT_EN (1<<0)
#define CS1000LITE_LED_PWM_PWM_INT_RAW (1<<1)
#define CS1000LITE_LED_PWM_PWM_INT_STATUS (1<<2)
#define CS1000LITE_LED_PWM_PWM_INT_CLR (1<<3)

//pwm0_end_val_use
#define CS1000LITE_LED_PWM_PWM_END_VAL_USE(n) (((n)&0xFFFFFFFF)<<0)

//pwm0_step_cnt
#define CS1000LITE_LED_PWM_PWM_STEP_CYC_CNT(n) (((n)&0xFFFF)<<0)
#define CS1000LITE_LED_PWM_PWM_STEP_NUM_CNT(n) (((n)&0xFFFF)<<16)
