...
typedef enum {
    ASDMA_ID_CS1000_UART0_RX   = 0,
    ASDMA_ID_CS1000_UART0_TX   = 1,
    ASDMA_ID_CS1000_UART1_RX   = 2,
    ASDMA_ID_CS1000_UART1_TX   = 3,
    ASDMA_ID_CS1000_UART2_RX   = 4,
    ASDMA_ID_CS1000_UART2_TX   = 5,
    ASDMA_ID_CS1000_SPI0_RX    = 6,
    ASDMA_ID_CS1000_SPI0_TX    = 7,
    ASDMA_ID_CS1000_SPI1_RX    = 8,
    ASDMA_ID_CS1000_SPI1_TX    = 9,
    ASDMA_ID_CS1000_SDMMC_RX   = 10,
    ASDMA_ID_CS1000_SDMCC_TX   = 11,
    ASDMA_ID_CS1000_I2CM0_RX   = 12,
    ASDMA_ID_CS1000_I2CM0_TX   = 13,
    ASDMA_ID_CS1000_I2CM1_RX   = 14,
    ASDMA_ID_CS1000_I2CM1_TX   = 15,
    ASDMA_ID_CS1000_CAMERA_RX  = 16,
...
typedef void (*CS_DMA_IRQ_HANDLER_T)(uint8_t dma_type, uint8_t ch, uint32_t int_status);
